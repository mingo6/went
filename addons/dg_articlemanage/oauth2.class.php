...
class Oauth2
{
    ...
    public function  getOauthAccessToken($code)
    {
        ...
        if($this->current_account['type']==4){
        	$oauth2_code = "https://api.weixin.qq.com/sns/oauth2/component/access_token?appid={$this->appid}&code={$code}&grant_type=authorization_code&component_appid={$this->party->appid}&component_access_token={$this->party->get_component_token()}";
        }
