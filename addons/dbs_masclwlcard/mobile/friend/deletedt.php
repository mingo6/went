...
$result = pdo_delete("dbs_masclwlcard_friend", array("id" => $id, "uniacid" => $uniacid));
if (!empty($result)) {
    pdo_delete("dbs_masclwlcard_pl", array("fid" => $id, "uniacid" => $uniacid));
    pdo_delete("dbs_masclwlcard_zan", array("fid" => $id, "uniacid" => $uniacid));
