...
class Op_EweiShopV2Page extends MerchWebPage 
{
	...
	public function close() 
	{
		...
		if ($_W['ispost']) 
		{
			...
			{
				m('member')->setCredit($item['openid'], 'credit1', $item['deductcredit'], array('0', $_W['shopset']['shop']['name'] . '购物返还抵扣积分币 积分币: ' . $item['deductcredit'] . ' 抵扣金额: ' . $item['deductprice'] . ' 订单号: ' . $item['ordersn']));
			}
