		...
		public function sendMessage($id = 0) 
		{
			...
			if ($log['status'] == 2) 
			{
				...
				else if ($log['dispatchstatus'] != 1) 
				{
					...
					$msg = array( 'first' => array('value' => '恭喜您，商品兑换成功~', 'color' => '#4a5077'), 'keyword1' => array('title' => '奖品名称', 'value' => $goods['title'], 'color' => '#4a5077'), 'keyword2' => array('title' => '消耗积分币', 'value' => $credits, 'color' => '#4a5077'), 'keyword3' => array('title' => '剩余积分币', 'value' => $credit, 'color' => '#4a5077'), 'keyword4' => array('title' => '兑换时间', 'value' => date('Y-m-d', time()), 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
