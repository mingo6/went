...
class Agent_EweiShopV2Page extends PluginWebPage 
{
	public function main() 
	{
		...
		if(!empty($searchfield) && $searchfield == 'superagent'){
			$condition .= 'AND dm.issuperagent = 1';
		}
