...
class Payment_EweiShopV2Page extends WebPage 
{
	...
	protected function post() 
	{
		...
		if ($_W['ispost']) 
		{
			$data = array('uniacid' => $_W['uniacid'], 'type' => intval($_GPC['type']), 'title' => trim($_GPC['title']), 'appid' => trim($_GPC['appid']), 'miniapp_appid' => trim($_GPC['miniapp_appid']), 'miniapp_secret' => trim($_GPC['miniapp_secret']), 'mch_id' => trim($_GPC['mch_id']), 'apikey' => trim($_GPC['apikey']), 'sub_appid' => trim($_GPC['sub_appid']), 'sub_appsecret' => trim($_GPC['sub_appsecret']), 'sub_mch_id' => trim($_GPC['sub_mch_id']), 'is_raw' => intval($_GPC['is_raw']));
