...
class Index_EweiShopV2Page extends WebPage 
{
	public function main() 
	{
		if (cv('sysset.shop')) 
		{
			headers(webUrl('sysset/shop'));
		}
		else if (cv('sysset.follow')) 
		{
			headers(webUrl('sysset/follow'));
		}
		else if (cv('sysset.wap')) 
		{
			headers(webUrl('sysset/wap'));
		}
		else if (cv('sysset.pcset')) 
		{
			headers(webUrl('sysset/pcset'));
		}
		else if (cv('sysset.notice')) 
		{
			headers(webUrl('sysset/notice'));
		}
		else if (cv('sysset.trade')) 
		{
			headers(webUrl('sysset/trade'));
		}
		else if (cv('sysset.payset')) 
		{
			headers(webUrl('sysset/payset'));
		}
		else if (cv('sysset.templat')) 
		{
			headers(webUrl('sysset/templat'));
		}
		else if (cv('sysset.member')) 
		{
			headers(webUrl('sysset/member'));
		}
		else if (cv('sysset.category')) 
		{
			headers(webUrl('sysset/category'));
		}
		else if (cv('sysset.contact')) 
		{
			headers(webUrl('sysset/contact'));
		}
		else if (cv('sysset.qiniu')) 
		{
			headers(webUrl('sysset/qiniu'));
		}
		else if (cv('sysset.sms.set')) 
		{
			headers(webUrl('sysset/sms/set'));
		}
		else if (cv('sysset.sms.temp')) 
		{
			headers(webUrl('sysset/sms/temp'));
		}
		else if (cv('sysset.close')) 
		{
			headers(webUrl('sysset/close'));
		}
		else if (cv('sysset.tmessage')) 
		{
			headers(webUrl('sysset/tmessage'));
		}
		else if (cv('sysset.cover')) 
		{
			headers(webUrl('sysset/cover'));
		}
		else if (cv('sysset.area')) 
		{
			headers(webUrl('sysset/area'));
		}
		else 
		{
			headers(webUrl());
