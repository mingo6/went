...
class Index_EweiShopV2Page extends ComWebPage 
{
	...
	public function main() 
	{
		if (cv('sale.enough')) 
		{
			headers(webUrl('sale/enough'));
		}
		else if (cv('sale.enoughfree')) 
		{
			headers(webUrl('sale/enoughfree'));
		}
		else if (cv('sale.deduct')) 
		{
			headers(webUrl('sale/deduct'));
		}
		else if (cv('sale.recharge')) 
		{
			headers(webUrl('sale/recharge'));
		}
	...
	public function credit1() 
	{
		...
		if ($_W['ispost']) 
		{
			...
			plog('sale.credit1.edit', '修改基本积分币活动配置');
