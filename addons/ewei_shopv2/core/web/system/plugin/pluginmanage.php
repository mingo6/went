...
class Pluginmanage_EweiShopV2Page extends SystemPage 
{
	...
	protected function post() 
	{
		...
		if ($_W['ispost']) 
		{
			$data = array('displayorder' => intval($_GPC['displayorder']), 'pluginid' => intval($_GPC['pluginid']), 'thumb' => save_media($_GPC['thumb']), 'state' => intval($_GPC['state']), 'content' => m('common')->html_images($_GPC['content']));
			$dates = array();
