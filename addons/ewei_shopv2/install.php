...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_member` (
  ...
  `issuperagent` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `superagenttime` int(10) unsigned NOT NULL DEFAULT '0',
  `agentid_str` text NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_payment` (
  ...
  `miniapp_appid` varchar(20) NOT NULL DEFAULT '',
  `miniapp_secret` varchar(32) NOT NULL DEFAULT '',
...
(16, '积分币变动提醒', 'backpoint_ok', 'OPENTM207509450', 't4X8tcZsZRfiLaxvlZSd9QTgmQTZRpy110DgoJeu4DU', '积分币变动提醒', '{{first.DATA}}获得时间：{{keyword1.DATA}}获得积分币：{{keyword2.DATA}}获得原因：{{keyword3.DATA}}当前积分币：{{keyword4.DATA}}{{remark.DATA}}', 0, 'sys', '系统消息通知'),
...
(25, '积分币兑换成功通知', 'exchange_score', 'OPENTM207509450', '', '积分币变动提醒', '{{first.DATA}}获得时间：{{keyword1.DATA}}获得积分币：{{keyword2.DATA}}获得原因：{{keyword3.DATA}}当前积分币：{{keyword4.DATA}}{{remark.DATA}}', 0, 'exchange', '兑换中心消息通知'),
...
(10, 10, 'creditshop', '积分币商城', '1.0', '官方', 1, 'biz', 0, '../addons/ewei_shopv2/static/images/creditshop.jpg', '', 0, 0),
...
(25, 29, 'sign', '积分币签到', '1.0', '官方', 1, 'tool', 1, '../addons/ewei_shopv2/static/images/sign.jpg', '', 0, 0),
...
DROP TABLE IF EXISTS `ims_ewei_shop_apply_after_sale`;
CREATE TABLE `ims_ewei_shop_apply_after_sale` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` smallint(5) unsigned NOT NULL,
  `openid` varchar(30) NOT NULL,
  `mobile` decimal(11,0) unsigned NOT NULL,
  `name` varchar(20) NOT NULL,
  `express_numbers` varchar(100) NOT NULL,
  `express_name` varchar(10) NOT NULL,
  `status` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `goods_name` varchar(50) NOT NULL,
  `goods_model` varchar(50) NOT NULL,
...
DROP TABLE IF EXISTS `ims_ewei_shop_waterorder`;
CREATE TABLE `ims_ewei_shop_waterorder` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL DEFAULT '0',
  ...
  `is_pay` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1已支付 0未支付',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0、已取消 1、未付款 2、已付款 3、已发货 4、退货中 5、已完成 6、已关闭  7、已退货',
  `pay_time` int(11) NOT NULL DEFAULT '0' COMMENT '支付时间',
  `remark` varchar(255) NOT NULL DEFAULT '' COMMENT '备注',
  `mobile` varchar(20) NOT NULL DEFAULT '' COMMENT '手机号',
  `address` varchar(255) NOT NULL DEFAULT '' COMMENT '地址',
  `uniacid` int(11) NOT NULL DEFAULT '0' COMMENT '公众号id',
  `water_id` int(11) NOT NULL DEFAULT '0' COMMENT '产品 id',
  `water_name` varchar(255) NOT NULL DEFAULT '' COMMENT '产品名称',
  `pay_type` varchar(255) NOT NULL DEFAULT '' COMMENT '支付方式 credit:余额支付  wechat:微信支付',
  `linkman` varchar(255) NOT NULL DEFAULT '' COMMENT '收货人姓名',
  `refund_mark` varchar(255) NOT NULL DEFAULT '' COMMENT '退货说明',
  `refund_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 未退货 1退款退货',
  `send_time` int(11) NOT NULL DEFAULT '0' COMMENT '发货时间',
  `finish_time` int(11) NOT NULL DEFAULT '0' COMMENT '完成时间',
  `cancel_mark` varchar(255) NOT NULL DEFAULT '' COMMENT '取消原因',
  `num` int(11) NOT NULL DEFAULT '1' COMMENT '数量',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `ims_ewei_shop_water`;
CREATE TABLE `ims_ewei_shop_water` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '' COMMENT '产品名称 如：500ml 农夫山泉有点甜水',
  `num` int(11) NOT NULL DEFAULT '0' COMMENT '产品库存',
  `image` varchar(255) NOT NULL DEFAULT '' COMMENT '商品图片',
  `small_image` varchar(255) NOT NULL DEFAULT '' COMMENT '商品缩略图',
  `price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '产品价格',
  `already_num` int(11) NOT NULL DEFAULT '0' COMMENT '已经销售数量',
  `is_on` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0 不上架 1上架',
  `uniacid` int(11) NOT NULL DEFAULT '0' COMMENT '公众号id',
  `create_time` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `ims_ewei_shop_watertime`;
CREATE TABLE `ims_ewei_shop_watertime` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `small_time` int(11) NOT NULL DEFAULT '0' COMMENT '最小时间',
  `last_time` int(11) NOT NULL DEFAULT '0' COMMENT '最大时间',
  `uniacid` int(11) NOT NULL DEFAULT '1' COMMENT '共红歌会id',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
