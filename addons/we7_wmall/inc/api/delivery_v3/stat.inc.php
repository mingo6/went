...
elseif($op == 'mine') {
	...
	foreach($records_timeout as $val) {
		...
		$records_percent[$val['deliveryer_id']] = array(
			'percent_timeout' => $val['percent_timeout'],
			'percent_normal' => $val['percent_normal'],
		);
	}
