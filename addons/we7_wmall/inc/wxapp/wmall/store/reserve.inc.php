...
if($ta == 'index') {
	...
	$days = array(
		array(
			'day' => date('m-d'),
			'day_cn' => '今天',
			'week_cn' => date2week(TIMESTAMP),
		),
		array(
			'day' => date('m-d', strtotime("+1 day")),
			'day_cn' => '明天',
			'week_cn' => date2week(strtotime("+1 day")),
		),
		array(
			'day' => date('m-d', strtotime("+2 day")),
			'day_cn' => '后天',
			'week_cn' => date2week(strtotime("+2 day")),
		),
		array(
			'day' => date('m-d', strtotime("+3 day")),
			'day_cn' => date('m-d', strtotime("+3 day")),
			'week_cn' => date2week(strtotime("+3 day")),
		),
		array(
			'day' => date('m-d', strtotime("+4 day")),
			'day_cn' => date('m-d', strtotime("+4 day")),
			'week_cn' => date2week(strtotime("+4 day")),
		),
		array(
			'day' => date('m-d', strtotime("+5 day")),
			'day_cn' => date('m-d', strtotime("+5 day")),
			'week_cn' => date2week(strtotime("+5 day")),
		),
	);
...
elseif($ta == 'post') {
	...
	$order = array(
		...
		'coupon' => coupon_available_check($sid, $recordid, $cart['price']),
	);
