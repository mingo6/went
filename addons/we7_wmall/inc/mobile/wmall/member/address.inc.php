...
if($redirect_type == 'order'){
    $param = array( "sid" => $_GPC["sid"], "r" => 1, "recordid" => $_GPC["recordid"], "redPacket_id" => $_GPC["redPacket_id"] );
}else{
    $param =  array( "goods_id" => $_GPC["goods_id"], "type" => $_GPC["type"], "r" => 1, "recordid" => $_GPC["recordid"], "redPacket_id" => $_GPC["redPacket_id"] );
}
$routes = array( 
    "order" => imurl("wmall/order/create/index", $param) . "&address_id=",
    "group_order" => imurl("allgroupgoods/order/index", $param) . "&address_id=",
);
$param['redirect_input'] = $redirect_input;
