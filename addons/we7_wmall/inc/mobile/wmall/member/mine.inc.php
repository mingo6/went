...
{
    $urls["redpacket"] = array( "title" => "我的红包", "url" => imurl("wmall/member/redPacket"), "css" => "", "icon" => "hongbao.png" );
}
...
//砍价、秒杀、拼团
$urls['cutPrice'] = array("title" => "砍价", "url" => imurl("cutPrice/index"), "css" => "", "icon" => "kanjia.png");
$urls['allgroupgoods'] = array("title" => "拼团", "url" => imurl("allgroupgoods/index"), "css" => "", "icon" => "pintuan.png");
$urls['secondKill'] = array("title" => "秒杀", "url" => imurl("secondKill/index"), "css" => "", "icon" => "miaosha.png");

//分销二维码
$urls['myCode'] = array("title" => "我要代言", "url" => imurl("wmall/member/myCode"), "css" => "", "icon" => "qr_code.png");

//提现
$urls['getcash'] = array("title" => "提现", "url" => imurl("wmall/member/getcash"), "css" => "", "icon" => "tixian.png");

//提现
$urls['company'] = array("title" => "公司介绍", "url" => imurl("wmall/member/company"), "css" => "", "icon" => "gonsi.png");
//echo "<pre>";
//var_dump($_W['member']);die;
