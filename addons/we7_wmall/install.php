...
CREATE TABLE `ims_tiny_wmall_errander_category` (
  ...
  `price_thumb` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `uniacid` (`uniacid`),
  KEY `agentid` (`agentid`),
  KEY `status` (`status`)
...
(23,	'advertise',	'biz',	'商户广告通',	'../addons/we7_wmall/static/img/plugin/advertise.jpg',	'',	'商户广告通',	1,	0,	1),
(24,	'superCoupon',	'activity',	'超级代金券',	'../addons/we7_wmall/static/img/plugin/superCoupon.jpg',	'',	'超级代金券',	1,	0,	1),
(25, 'allgroupgoods', 'activity', '拼团', '../addons/we7_wmall/static/img/plugin/errander.jpg', '', '拼团', 1, 0, 1),
(26, 'secondkill', 'activity', '秒杀', '../addons/we7_wmall/static/img/plugin/errander.jpg', '', '秒杀', 1, 0, 1),
(26, 'cutPrice', 'activity', '砍价', '../addons/we7_wmall/static/img/plugin/errander.jpg', '', '砍价', 1, 0, 1);
...
DROP TABLE IF EXISTS `ims_tiny_wmall_allgroupgoods_category`;
CREATE TABLE `ims_tiny_wmall_allgroupgoods_category` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uniacid` int(10) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  `thumb` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `ims_tiny_wmall_allgroupgoods_goods`;
CREATE TABLE `ims_tiny_wmall_allgroupgoods_goods` (
  ...
  `ycd_num` int(11) NOT NULL DEFAULT '0' COMMENT '已成团数量',
  ...
  `is_shelves` tinyint(3) NOT NULL DEFAULT '1' COMMENT '1上架,2下架',
...
DROP TABLE IF EXISTS `ims_tiny_wmall_allgroupgoods_order`;
CREATE TABLE `ims_tiny_wmall_allgroupgoods_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `ims_tiny_wmall_allgroupgoods_group`;
CREATE TABLE `ims_tiny_wmall_allgroupgoods_group` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `uid` int(11) NOT NULL COMMENT '团长user_id',
  `uniacid` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `ims_tiny_wmall_secondkill_category`;
CREATE TABLE `ims_tiny_wmall_secondkill_category` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uniacid` int(10) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  `displayorder` tinyint(3) DEFAULT '0',
...
DROP TABLE IF EXISTS `ims_tiny_wmall_secondkill_goods`;
CREATE TABLE `ims_tiny_wmall_secondkill_goods` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(30) NOT NULL,
  `thumb` varchar(255) NOT NULL,
  `y_price` decimal(10,1) NOT NULL COMMENT '原价',
  `s_price` decimal(10,1) NOT NULL COMMENT '现价',
  ...
  `uniacid` int(11) NOT NULL,
  `is_shelves` tinyint(3) NOT NULL DEFAULT '1' COMMENT '1.上架2.下架',
...
DROP TABLE IF EXISTS `ims_tiny_wmall_secondkill_user`;
CREATE TABLE `ims_tiny_wmall_secondkill_user` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `sid` int(10) NOT NULL,
...
DROP TABLE IF EXISTS `ims_tiny_wmall_secondkill_order`;
CREATE TABLE `ims_tiny_wmall_secondkill_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) NOT NULL,
  `uid` int(11) NOT NULL,
  `order_no` varchar(100) NOT NULL,
...
DROP TABLE IF EXISTS `ims_tiny_wmall_cutPrice_category`;
CREATE TABLE `ims_tiny_wmall_cutPrice_category` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uniacid` int(10) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  `displayorder` tinyint(3) DEFAULT '0',
...
DROP TABLE IF EXISTS `ims_tiny_wmall_cutPrice_goods`;
CREATE TABLE `ims_tiny_wmall_cutPrice_goods` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(30) NOT NULL,
  `thumb` varchar(255) NOT NULL,
  `y_price` decimal(10,1) NOT NULL COMMENT '原价',
  `s_price` decimal(10,1) NOT NULL COMMENT '最低价',
  `number` int(11) NOT NULL COMMENT '数量',
  `start_time` int(11) NOT NULL COMMENT '开始时间',
  `end_time` int(11) NOT NULL COMMENT '结束时间',
  `details` text NOT NULL,
  ...
  `introduction` varchar(255) NOT NULL,
  `sale_num` int(11) NOT NULL DEFAULT '0',
  `cut_min_price` decimal(10,2) NOT NULL,
  `cut_people_num` int(11) NOT NULL,
  `cut_max_price` decimal(10,2) NOT NULL,
  `sid` int(11) NOT NULL DEFAULT '0',
  `gid` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `ims_tiny_wmall_cutPrice_firend`;
CREATE TABLE `ims_tiny_wmall_cutPrice_firend` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `kid` int(10) NOT NULL,
  `uid` int(10) NOT NULL,
  `openid` varchar(200) NOT NULL,
  `nickname` varchar(100) NOT NULL,
  `headimgurl` varchar(200) NOT NULL,
  `k_price` decimal(10,2) DEFAULT NULL,
  `kh_price` decimal(10,2) DEFAULT NULL,
  `createtime` int(10) DEFAULT '0',
  `ip` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `ims_tiny_wmall_cutPrice_user`;
CREATE TABLE `ims_tiny_wmall_cutPrice_user` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `kid` int(10) NOT NULL,
  `openid` varchar(200) NOT NULL,
  `nickname` varchar(100) NOT NULL,
...
DROP TABLE IF EXISTS `ims_tiny_wmall_order_commission_log`;
CREATE TABLE `ims_tiny_wmall_order_commission_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `orderId` int(11) NOT NULL,
  `userId` int(11) NOT NULL,
  `money` decimal(10,2) NOT NULL,
  `createTime` int(11) NOT NULL,
  `unicaid` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `ims_tiny_wmall_member_getcash_log`;
CREATE TABLE `ims_tiny_wmall_member_getcash_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0',
  `uid` int(10) unsigned NOT NULL DEFAULT '0',
  `trade_no` varchar(20) NOT NULL,
  ...
  `agentid` int(10) unsigned NOT NULL DEFAULT '0',
  `channel` varchar(10) NOT NULL DEFAULT 'weixin',
  `wx_account` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `ims_tiny_wmall_errander_type`;
CREATE TABLE `ims_tiny_wmall_errander_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `errander_name` varchar(20) NOT NULL,
  `deliveryer_name` varchar(20) NOT NULL,
