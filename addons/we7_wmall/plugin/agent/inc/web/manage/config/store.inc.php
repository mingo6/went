...
if ($op == 'delivery') 
{
	...
	if ($_W['ispost']) 
	{
		...
		{
			$delivery['delivery_fee'] = array('start_fee' => trim($_GPC['start_fee']), 'start_km' => trim($_GPC['start_km']), 'pre_km_fee' => trim($_GPC['pre_km_fee']), 'distance_type' => intval($_GPC['distance_type']));
		}
