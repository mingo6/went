...
if($op == 'list'){
    ...
    //订单统计
    $condition = ' where uniacid = :uniacid and status = 5 and order_type < 3 and stat_day = :stat_day and type = 1';
    ...
    $condition = ' WHERE uniacid = :uniacid and order_type < 3 and type = 1';
    $params = array(
        ':uniacid' => $_W['uniacid'],
    );
    ...
    include itemplate('cutPriceList');
}
