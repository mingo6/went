...
if( $op == "index" ) 
{
	...
	$category_list = pdo_getall("tiny_wmall_errander_category",array("type"=>$category["type"],"status"=>1,"uniacid" => $_W["uniacid"]));


	if (!in_array($category["type"],array("buy","delivery","pickup","errand","express"))){
