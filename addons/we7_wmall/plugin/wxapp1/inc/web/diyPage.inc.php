		...
		$page['data'] = array (
			...
			'items' => array (
				...
				'M1528853610330' => array (
						...
						'data' => array (
							'C1528853610330' => array (
								'icon' => 'icon-money',
								'imgurl' => '../addons/we7_wmall/plugin/wxapp/static/img/default/navs-1.png',
								'linkurl' => 'pages/member/redPacket/index',
								'text' => '我的红包',
								'textcolor' => '#000000',
								'placeholder' => '暂无可用',
								'placeholdercolor' => '#cccccc',
							...
							'C1528853610331' => array (
								'icon' => 'icon-iconpiaoquan01',
								'imgurl' => '../addons/we7_wmall/plugin/wxapp/static/img/default/navs-2.png',
								'linkurl' => 'pages/member/coupon/index',
								'text' => '我的代金券',
								'textcolor' => '#000000',
								'placeholder' => '暂无可用',
								'placeholdercolor' => '#cccccc',
				...
				'M1528853604178' => array (
					...
					'data' => array (
						'C1528853604180' => array (
							'icon' => 'icon-shop',
							'imgurl' => '../addons/we7_wmall/plugin/wxapp/static/img/default/navs-3.png',
							'linkurl' => 'pages/channel/brand',
							'text' => '为您优选',
							'textcolor' => '#000000',
							'placeholder' => '暂未购买',
							'placeholdercolor' => '#cccccc',
						...
						'M1528854583730' => array (
							'icon' => 'icon-iconpiaoquan01',
							'imgurl' => '../addons/we7_wmall/plugin/wxapp/static/img/default/navs-1.png',
							'linkurl' => 'pages/channel/coupon',
							'text' => '领券中心',
							'textcolor' => '#000000',
							'placeholder' => '4个未使用',
							'placeholdercolor' => '#cccccc',
						...
						'C1528853604178' => array (
							'icon' => 'icon-creative',
							'imgurl' => '../addons/we7_wmall/plugin/wxapp/static/img/default/navs-1.png',
							'linkurl' => 'pages/home/help',
							'text' => '帮助与反馈',
							'textcolor' => '#000000',
							'placeholder' => '4个未使用',
							'placeholdercolor' => '#cccccc',
				...
				'M1528853617410' => array (
					...
					'data' => array (
						'C1528853617410' => array (
							'icon' => 'icon-store',
							'imgurl' => '../addons/we7_wmall/plugin/wxapp/static/img/default/navs-1.png',
							'linkurl' => 'pages/store/settle',
							'text' => '商家入驻',
							'textcolor' => '#000000',
							'placeholder' => '4个未使用',
							'placeholdercolor' => '#cccccc',
						...
						'C1528853617412' => array (
							'icon' => 'icon-friend',
							'imgurl' => '../addons/we7_wmall/plugin/wxapp/static/img/default/navs-2.png',
							'linkurl' => 'pages/spread/index',
							'text' => '啦啦推广',
							'textcolor' => '#000000',
							'placeholder' => '9个未使用',
							'placeholdercolor' => '#cccccc',
						...
						'C1528853617413' => array (
							'icon' => 'icon-refund',
							'imgurl' => '../addons/we7_wmall/plugin/wxapp/static/img/default/navs-3.png',
							'linkurl' => 'pages/ordergrant/index',
							'text' => '下单有礼',
							'textcolor' => '#000000',
							'placeholder' => '暂未购买',
							'placeholdercolor' => '#cccccc',
				...
				'M1528857812641' => array (
					'params' => array (
						'content' => '啦啦外卖版权所有',
						'imgurl' => '../addons/we7_wmall/plugin/wxapp/static/img/default/copyright.png',
					),
					'style' => array(
						'showimg' => 1,
						'style' => 1,
