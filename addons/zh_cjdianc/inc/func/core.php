...
class Core extends WeModuleSite
{
    ...
    public function getMainMenu()
    {
        ...
        $navemenu[19] = array(
          ...
          $navemenu[18] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=allgroupgoods&m=zh_cjdianc" class="panel-title wytitle" id="yframe-18"><icon style="color:#8d8d8d;" class="fa fa-life-ring"></icon>  拼团管理</a>',
                'items' => array(
