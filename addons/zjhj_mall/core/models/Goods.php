 ...
 * @property string $share_commission_first_score
 * @property string $share_commission_second_score
 * @property string $share_commission_third_score
...
class Goods extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['store_id', 'cat_id', 'status', 'addtime', 'is_delete', 'sort', 'virtual_sales', 'individual_share', 'freight', 'use_attr', 'share_type', 'is_form', 'is_open_privilege'], 'integer'],
            [['price', 'original_price', 'share_commission_first', 'share_commission_second', 'share_commission_third', 'share_commission_first_score', 'share_commission_second_score', 'share_commission_third_score', 'weight'], 'number'],
            [['detail', 'attr', 'cover_pic', 'video_url', 'full_cut', 'integral'], 'string'],
            [['name', 'goods_sn', 'unit'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'share_commission_first_score' => '一级分销积分比例',
            'share_commission_second_score' => '二级分销积分比例',
            'share_commission_third_score' => '三级分销积分比例',
            'weight' => '重量',
            'freight' => '运费模板ID',
            'full_cut' => '满减',
            'integral' => '积分设置',
