 ...
 * @property string $first_score
 * @property string $second_score
 * @property string $third_score
...
class Order extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['total_price', 'pay_price', 'express_price', 'first_price', 'second_price', 'third_price', 'first_score', 'second_score', 'third_score', 'coupon_sub_price', 'before_update_price', 'discount'], 'number'],
