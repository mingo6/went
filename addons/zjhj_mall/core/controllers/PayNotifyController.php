...
class PayNotifyController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        file_put_contents('./WXRES.txt',$xml,FILE_APPEND);
...
//        if ($order->getSurplusGruop())
    ...
    private function setReturnData($order)
    {
        ...
        $order->first_score = $first_score < 0.01 ? 0 : $first_score;
        $order->second_score = $second_score < 0.01 ? 0 : $second_score;
        $order->third_score = $third_score < 0.01 ? 0 : $third_score;
        $order->save();
    }
