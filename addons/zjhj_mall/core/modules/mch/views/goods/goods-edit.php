        ...
        <div class="body">
            ...
            <div class="step-block" flex="dir:left box:first">
                ...
                <div>
                    ...
                    <div class="form-group row">
                        <div class="col-3 text-right">
                            <label class=" col-form-label required">商品货号</label>
                        </div>
                        <div class="col-9">
                            <input class="form-control short-row" type="text" name="model[goods_sn]"
                                   value="<?= $goods['goods_sn'] ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-3 text-right">
            ...
            <div class="step-block" flex="dir:left box:first">
                ...
                <div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9 col-form-label">
                            <label class="custom-control custom-radio">
                                <input <?= isset($goods['is_form']) && $goods['is_form'] == 0 ? 'checked' : null ?> value="0" name="model[is_form]" type="radio" class="custom-control-input">
                                <span class="custom-control-indicator"></span>
                                <span class="custom-control-description">不开启</span>
                            </label>
                            <label class="custom-control custom-radio">
                                <input <?= !isset($goods['is_form']) || $goods['is_form'] == 1 ? 'checked' : null ?> value="1" name="model[is_form]" type="radio" class="custom-control-input">
                                <span class="custom-control-indicator"></span>
                    ...
                    <div class="form-group row">
                        <div class="col-3 text-right">
                            <label class="col-form-label">是否开启查看商品等级权限</label>
                        </div>
                        <div class="col-9 col-form-label">
                            <label class="custom-control custom-radio">
                                <input <?= !isset($goods['is_open_privilege']) || $goods['is_open_privilege'] == 0 ? 'checked' : null ?> value="0" name="model[is_open_privilege]" type="radio" class="custom-control-input">
                                <span class="custom-control-indicator"></span>
                                <span class="custom-control-description">不开启</span>
                            </label>
                            <label class="custom-control custom-radio">
                                <input <?= isset($goods['is_open_privilege']) && $goods['is_open_privilege'] == 1 ? 'checked' : null ?> value="1" name="model[is_open_privilege]" type="radio" class="custom-control-input">
                                <span class="custom-control-indicator"></span>
                                <span class="custom-control-description">开启</span>
                            </label>
                        </div>
                    ...
                    <div class="form-group row share-commission">
                        ...
                        <div class="col-9">
                            <div class="short-row">
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-addon">一级分佣积分</span>
                                    <input name="model[share_commission_first_score]"
                                           value="<?= $goods['share_commission_first_score'] ?>"
                                           class="form-control"
                                           type="number"
                                           step="0.01"
                                           min="0" max="100">
                                    <span class="input-group-addon percent percent_score"><?= $goods->share_type == 1 ? "积分" : "%" ?></span>
                                </div>
                                <div class="input-group mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-addon">二级分佣积分</span>
                                    <input name="model[share_commission_second_score]"
                                           value="<?= $goods['share_commission_second_score'] ?>"
                                           class="form-control"
                                           type="number"
                                           step="0.01"
                                           min="0" max="100">
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-addon">三级分佣积分</span>
                                    <input name="model[share_commission_third_score]"
                                           value="<?= $goods['share_commission_third_score'] ?>"
                                           class="form-control"
                                           type="number"
                                           step="0.01"
                                           min="0" max="100">
