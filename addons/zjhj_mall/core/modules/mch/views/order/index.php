                    ...
                    <td class="order-tab-5">
                        ...
                        <?php else: ?>
                            <?php if ($order_item['is_pay'] == 1 && $order_item['is_confirm'] != 1): ?>
                                <a class="btn btn-sm btn-primary send-btn" href="javascript:" data-order-id="<?= $order_item['id'] ?>"><?= ($order_item['is_send'] == 1) ? "修改快递单号" : "发货" ?></a>
                                <?php if ($order_item['is_offline'] == 1): ?>
                                    <a class="btn btn-sm btn-primary" href="javascript:">到店自提</a>
                                <?php else: ?>
                                <?php endif; ?>
                            <?php endif; ?>
                        <?php endif; ?>
                        <a class="btn btn-sm btn-primary" href="<?= $urlManager->createUrl(['mch/order/detail', 'order_id' => $order_item['id']]) ?>">详情</a>
                    </td>
                </tr>
                <tr>
                    <td colspan="5">
