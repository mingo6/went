...
class LoginForm extends Model
{
    ...
    public function login()
    {
        ...
        //打开调试模式
        if($debug){
            $session_key = $res['session_key'] = $res['openid'] = 'oLfEY4z4bGvGHYilROtM6r5CepdQ';
            $errCode = 0;
            $data = json_encode(array(
                'openId' => $res['openid'],
                'unionId' => '',
                'nickName' => '英子',
                'avatarUrl' => 'https://wx.qlogo.cn/mmopen/vi_32/icJmoIkAqjHib2NwHrgSfyChklYxoClpz4EALgicolE6yPvrQQ8qu68iasyvKW51St0iaX3VgCvjcpS8nFJD6Ed0SAg/132',
            ));
        }else{
