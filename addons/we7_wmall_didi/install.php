...
(3,	'customerApp',	'biz',	'用户端APP',	'../addons/we7_wmall/static/img/plugin/customerApp.jpg',	'',	'用户端APP',	1,	0,	0),
...
(8,	'deliveryerApp',	'biz',	'配送员APP',	'../addons/we7_wmall/static/img/plugin/deliveryerApp.jpg',	'',	'可在手机上接单 用户可实时查看配送员位置',	1,	0,	0),
(9,	'ordergrant',	'activity',	'下单有礼',	'../addons/we7_wmall/static/img/plugin/ordergrant.jpg',	'',	'下单给用户送积分或余额',	1,	0,	1),
...
(23,	'superCoupon',	'activity',	'超级代金券',	'../addons/we7_wmall/static/img/plugin/superCoupon.jpg',	'',	'超级代金券',	1,	0,	1);
