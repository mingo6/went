...
{
    global $_W;
    $args = array( "printDeviceInfo" => $printDeviceInfo, "order" => $order );
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if( $printDeviceInfo["type"] == "xixun" ) 
                                {
                                    ...
                                    $postdata = array( "dingdan" => $printDeviceInfo["content"], "dingdanID" => $order["print_sn"], "dayinjisn" => $printDeviceInfo["deviceno"], "pages" => $printDeviceInfo["times"], "indexID" => 10000, "dayinflag" => 1, "replyURL" => (string) $_W["siteroot"] . "addons/we7_wmall/payment/print/notify.php" );
                                }
                                else
                                {
