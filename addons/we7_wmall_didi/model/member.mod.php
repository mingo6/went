...
function get_member($openid, $field = 'openid') {
	global $_W;
	$uid = intval($openid);
	$fields = array('id', 'uid', 'groupid', 'groupid_updatetime', 'uid_majia', 'uid_qianfan', 'openid', 'openid_wxapp', 'token', 'credit1', 'credit2', 'avatar', 'nickname', 'sex', 'realname', 'mobile', 'password', 'mobile_audit', 'setmeal_id', 'setmeal_day_free_limit', 'setmeal_deliveryfee_free_limit', 'setmeal_starttime', 'setmeal_endtime', 'is_sys', 'status', 'addtime', 'spread1', 'spread2', 'spreadcredit2', 'spreadfixed', 'region_id', 'bucket_num', 'drinking_fountain_num');
	if($uid == 0) {
