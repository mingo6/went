...
if($ta == 'index') {
	...
	foreach($groups as $val) {
		if($val['is_system'] == 1 && $val['status'] == 1) {
			if($val['code'] > 20000) {//场景营销code从20001开始，//系统人群营销code从10001开始
...
if($ta == 'create') {
	...
	if($_W['ispost']) {
		if(empty($group['uids_total'])) {
			imessage(error(-1, '人群中没有符合条件的用户'), '', 'ajax');
		}
		...
		$coupon = array(
			...
			'data' => iserializer(array(
				'total_fee' => $group['uids_total'] * intval($_GPC['discount']),
				'grant_object' => array(
					'uids' => $group['uids'],
					'total' => $group['uids_total'],
					'unissued_uid' => $group['uids'],
					'grant_success' => 0,
				),
				'coupon' => array(
...
if($ta == 'send') {
	...
	if($_W['ispost']) {
		...
		$params = array(
			'sid' => $superCoupon['sid'],
			'coupon_id' => $superCoupon['id'],
			'type' => 'superCoupon',
			'condition' => $data['coupon']['condition'],
			'discount' => $data['coupon']['discount'],
			'use_days_limit' => $data['coupon']['use_days_limit'],
			'channel' => 'superCoupon',
		);
...
function run_creat_system_coupon_group($sid) {
	...
	if(in_array('superCoupon', $plugins)) {
		$system_groups = array(
			array('id' => '1','uniacid' => $_W['uniacid'],'sid' => $sid, 'is_system' => '1','title' => '需一般挽留的流失用户','content' => '曾经下单数、单价低于平均，但近30天未下单','group_condition' => 'a:3:{s:17:"store_member_type";i:2;s:8:"stat_day";i:1;s:12:"member_limit";a:6:{s:13:"no_order_days";i:30;s:17:"before_leave_days";i:90;s:16:"consume_num_type";i:1;s:18:"consume_price_type";i:1;s:20:"over_avg_consume_num";i:0;s:22:"over_avg_consume_price";i:0;}}','status'=> 1,'code' => '10001'),
			array('id' => '2','uniacid' => $_W['uniacid'],'sid' => $sid, 'is_system' => '1','title' => '需一般发展的用户','content' => '近30天下单数、单价低于平均','group_condition' => 'a:3:{s:17:"store_member_type";i:0;s:8:"stat_day";i:30;s:12:"member_limit";a:9:{s:20:"order_stat_date_type";i:0;s:13:"order_weekend";i:0;s:20:"order_stat_time_type";i:0;s:10:"is_comment";i:-1;s:11:"is_favorite";i:-1;s:16:"consume_num_type";i:1;s:18:"consume_price_type";i:1;s:20:"over_avg_consume_num";i:0;s:22:"over_avg_consume_price";i:0;}}','status'=> 1,'code' => '10002'),
			array('id' => '3','uniacid' => $_W['uniacid'],'sid' => $sid, 'is_system' => '1','title' => '需一般关怀的流失熟客','content' => '曾经下单数高于平均，单价低于平均，但近30天未下单','group_condition' => 'a:3:{s:17:"store_member_type";i:2;s:8:"stat_day";i:1;s:12:"member_limit";a:6:{s:13:"no_order_days";i:30;s:17:"before_leave_days";i:90;s:16:"consume_num_type";i:1;s:18:"consume_price_type";i:1;s:20:"over_avg_consume_num";i:1;s:22:"over_avg_consume_price";i:0;}}','status'=> 1,'code' => '10003'),
			array('id' => '4','uniacid' => $_W['uniacid'],'sid' => $sid, 'is_system' => '1','title' => '低消费熟客','content' => '近30天，下单数高于平均，但单价低于平均','group_condition' => 'a:3:{s:17:"store_member_type";i:0;s:8:"stat_day";i:30;s:12:"member_limit";a:9:{s:20:"order_stat_date_type";i:0;s:13:"order_weekend";i:0;s:20:"order_stat_time_type";i:0;s:10:"is_comment";i:-1;s:11:"is_favorite";i:-1;s:16:"consume_num_type";i:1;s:18:"consume_price_type";i:1;s:20:"over_avg_consume_num";i:1;s:22:"over_avg_consume_price";i:0;}}','status'=> 1,'code' => '10004'),
			array('id' => '5','uniacid' => $_W['uniacid'],'sid' => $sid, 'is_system' => '1','title' => '需重点挽留的流失用户','content' => '曾经下单数低于平均，单价高于平均，但近30天未下单','group_condition' => 'a:3:{s:17:"store_member_type";i:2;s:8:"stat_day";i:1;s:12:"member_limit";a:6:{s:13:"no_order_days";i:30;s:17:"before_leave_days";i:90;s:16:"consume_num_type";i:1;s:18:"consume_price_type";i:1;s:20:"over_avg_consume_num";i:0;s:22:"over_avg_consume_price";i:1;}}','status'=> 1,'code' => '10005'),
			array('id' => '6','uniacid' => $_W['uniacid'],'sid' => $sid, 'is_system' => '1','title' => '需重点发展的潜力用户','content' => '近30天，下单数低于平均，单价高于平均','group_condition' => 'a:3:{s:17:"store_member_type";i:0;s:8:"stat_day";i:30;s:12:"member_limit";a:9:{s:20:"order_stat_date_type";i:0;s:13:"order_weekend";i:0;s:20:"order_stat_time_type";i:0;s:10:"is_comment";i:-1;s:11:"is_favorite";i:-1;s:16:"consume_num_type";i:1;s:18:"consume_price_type";i:1;s:20:"over_avg_consume_num";i:0;s:22:"over_avg_consume_price";i:1;}}','status'=> 1,'code' => '10006'),
			array('id' => '7','uniacid' => $_W['uniacid'],'sid' => $sid, 'is_system' => '1','title' => '需重点关怀的流失熟客','content' => '曾经下单数、单价高于平均，但近30天未下单','group_condition' => 'a:3:{s:17:"store_member_type";i:2;s:8:"stat_day";i:1;s:12:"member_limit";a:6:{s:13:"no_order_days";i:30;s:17:"before_leave_days";i:90;s:16:"consume_num_type";i:1;s:18:"consume_price_type";i:1;s:20:"over_avg_consume_num";i:1;s:22:"over_avg_consume_price";i:1;}}','status'=> 1,'code' => '10007'),
			array('id' => '8','uniacid' => $_W['uniacid'],'sid' => $sid, 'is_system' => '1','title' => '高消费熟客','content' => '近30天下单数、单价高于平均','group_condition' => 'a:3:{s:17:"store_member_type";i:0;s:8:"stat_day";i:30;s:12:"member_limit";a:9:{s:20:"order_stat_date_type";i:0;s:13:"order_weekend";i:0;s:20:"order_stat_time_type";i:0;s:10:"is_comment";i:-1;s:11:"is_favorite";i:-1;s:16:"consume_num_type";i:1;s:18:"consume_price_type";i:1;s:20:"over_avg_consume_num";i:1;s:22:"over_avg_consume_price";i:1;}}','status'=> 1,'code' => '10008'),
			array('id' => '9','uniacid' => $_W['uniacid'],'sid' => $sid, 'is_system' => '1','title' => '粉丝用户','content' => '收藏店铺的用户，并且近90天有订单完成','group_condition' => 'a:3:{s:17:"store_member_type";i:0;s:8:"stat_day";i:90;s:12:"member_limit";a:7:{s:20:"order_stat_date_type";i:0;s:13:"order_weekend";i:0;s:20:"order_stat_time_type";i:0;s:10:"is_comment";i:-1;s:11:"is_favorite";i:1;s:16:"consume_num_type";i:0;s:18:"consume_price_type";i:0;}}','status'=> 1,'code' => '20001'),
			array('id' => '10','uniacid' => $_W['uniacid'],'sid' => $sid, 'is_system' => '1','title' => '昨日进店未下单新客','content' => '昨天进店，但未下单的新用户','group_condition' => 'a:3:{s:17:"store_member_type";i:1;s:8:"stat_day";i:1;s:12:"member_limit";a:1:{s:21:"store_new_member_type";i:0;}}','status'=> 1,'code' => '20002'),
		);
