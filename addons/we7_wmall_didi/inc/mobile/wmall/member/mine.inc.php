...
$urls = array( /* "coupon" => array( "title" => "我的代金券", "url" => imurl("wmall/member/coupon"), "css" => "", "icon" => "mypage_token.png" ),  *//* "favorite" => array( "title" => "我的收藏", "url" => imurl("wmall/member/favorite"), "css" => "", "icon" => "mypage_star.png" ), "comment" => array( "title" => "我的评价", "url" => imurl("wmall/member/comment"), "css" => "", "icon" => "mypage_comment.png" ), */"recharge" => array( "title" => "余额充值", "url" => imurl("wmall/member/recharge"), "css" => "", "icon" => "mypage_credit.png" ), /* "help" => array( "title" => "常见问题", "url" => imurl("wmall/home/help"), "css" => "", "icon" => "mypage_problem.png" ),  */"invoice" => array( "title" => "我的发票", "url" => imurl("wmall/member/invoice"), "css" => "", "icon" => "invoice.png"), "invoice" => array( "title" => "开票入口", "url" => imurl("wmall/member/entrance_invoice"), "css" => "", "icon" => "invoice.png") );
$addressCount = pdo_fetchcolumn('SELECT count(id) FROM ' . tablename('tiny_wmall_address') . ' WHERE uniacid=:uniacid AND uid=:uid ORDER BY is_default', array(':uniacid' => $_W['uniacid'], ':uid' => $_W["member"]["uid"]));
if(empty($addressCount)){
    $urls['address'] = array( "title" => "新增地址", "url" => imurl("wmall/member/address/post"), "css" => "", "icon" => "mypage_location.png" );
}
    $redpacket_status = false;
