    ...
    <form class="form">
            ...
            <div class="main-nav" flex="cross:center dir:left box:first">
                <div>
                    <nav class="breadcrumb rounded-0 mb-0" flex="cross:center">
                        ...
                        <a class="breadcrumb-item" href="<?= $urlManager->createUrl(['mch/order/index']) ?>">用户管理</a>
        ...
        <div class="form-body white-bg border-7">
            <div class="float-left pt-2">
                <a class="btn btn-orange" href="javascript:" data-toggle="modal" data-target="#edit" data-backdrop="static">添加核销员</a>
            </div>
            ...
            <table class="table table-bordered bg-white">
                ...
                <?php foreach ($list as $u): ?>
                    <tr>
                        ...
                        <td>
                            <?php if ($u['is_clerk'] == 0): ?>
                                <a class="btn btn-sm btn-orange del" href="javascript:"
                            ...
                            <?php endif; ?>
                            <a class="btn btn-orange btn-sm user-shop-edit" data-id="<?=$u['id']?>"
                                    ...
                                    <div style="max-height:400px;overflow: auto">
                                        <table class="table table-bordered">
                                            <tr v-for="(item,index) in show_user_list">
                                                ...
                                                <td>{{item.nickname}}</td>
                                                <td>
                                                    <a class="btn btn-orange btn-sm send" href="javascript:"
                ...
                <div class="modal fade" id="shop-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a class="btn btn-orange send" href="javascript:"
