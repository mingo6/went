...
<div class="main-body p-3">
    <form class="form auto-submit-form" method="post" autocomplete="off"
          data-return="<?= $urlManager->createUrl(['mch/site/article/index']) ?>" action="<?= $urlManager->createUrl(['mch/site/article/editart']) ?>">
        ...
        <div class="form-body white-bg border-7">
            <div class="form-group row">
                ...
                <div class="col-9">
                    ...
                    <input class="form-control" type="text" name="model[title]" value="<?= $article['title'] ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-9">
                    <select name="model[sortid]" class="form-control">
                        <?php foreach($sort as $k=>$v){?>
                        <option value="<?php echo $v['id'];?>" <?php if($v['id'] == $article['sortid']){ echo 'selected';}?>><?php echo $v['name'];?></optioin>
                        <?php }?>
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-9">
                    <input class="form-control" type="text" step="1" name="model[author]"
            ...
            <div class="form-group row">
                ...
                <div class="col-9">
                    <input class="form-control" id="datetimepicker" type="date" step="1" name="model[time]"
                           value="<?php echo date('Y-m-d',$article['time']);?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-1 text-left">
                    <label class=" col-form-label">文章内容</label>
                </div>
                <div class="col-9">
                    <textarea class="" id="editor" name="model[content]"><?= $article['content'] ?></textarea>
                </div>
            </div>
