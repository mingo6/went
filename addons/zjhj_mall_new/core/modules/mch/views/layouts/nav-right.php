...
<div class="nav-right">
    <div class="btn-group mr-4 message">
        <a href="javascript:" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img class="iconfont" src="/addons/zjhj_mall/core/web/statics/images/icon/message.png" style="width: 1.43rem;margin-right: 0.5rem;">消息
    ...
    <div class="btn-group">
        <a href="javascript:" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img class="iconfont" src="/addons/zjhj_mall/core/web/statics/images/icon/system.png" style="width: 1.43rem;margin-right: 0.5rem;">
            系统
        </a>
