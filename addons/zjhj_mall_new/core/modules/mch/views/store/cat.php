...
<div class="main-body p-3">
    <form class="form border-b-l border-b-r" style="overflow: hidden;">
            ...
            <div class="main-nav" flex="cross:center dir:left box:first">
                <div>
                    <nav class="breadcrumb rounded-0 mb-0" flex="cross:center">
                        ...
                        <a flex="cross:center" class="breadcrumb-item" href="<?= $urlManager->createUrl(['mch/store']) ?>">商品管理</a>
        ...
        <div class="form-body white-bg">
            <a href="<?= $urlManager->createAbsoluteUrl(['mch/store/cat-edit']) ?>" class="btn btn-orange mb-3">
                ...
                <?php foreach ($cat_list as $index => $cat): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-sm btn-default copy"  data-clipboard-text="/pages/cat/cat"
                    ...
                    <?php foreach ($cat->childrenList as $sub_cat): ?>
                        <tr class="bg-faded">
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-default copy"  data-clipboard-text="/pages/list/list?cat_id=<?=$sub_cat['id']?>"
                                   href="javascript:" hidden>复制链接</a>
                                <a class="btn btn-sm btn-default del"
