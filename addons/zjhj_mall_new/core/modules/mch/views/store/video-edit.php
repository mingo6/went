...
<div class="main-body p-3">
    <form class="form auto-submit-form" method="post" autocomplete="off"
        ...
        <div class="form-body white-bg border-7">
            ...
            <div class="form-group row">
                <label class="offset-3 col-4 col-form-label text-danger">排序按升序排列</label>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-4">
                    ...
                    <div class="text-left"><span class="num">0</span>/100</div>
                </div>
            </div>
            <div class="form-group row">
                <label class="offset-3 col-4 col-form-label text-danger"></label>
            </div>
