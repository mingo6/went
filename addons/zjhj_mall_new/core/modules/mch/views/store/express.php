...
<div class="main-body p-3">
    <form class="form">
        ...
        <div class="form-body white-bg border-b-l border-b-r">
            <a href="<?= $urlManager->createUrl(['mch/store/express-edit']) ?>" class="btn btn-orange mb-3" style="padding: 0.7rem 2rem; margin-right: 1rem;">
                <i class="iconfont icon-playlistadd"></i>添加面单打印设置</a>
            <a href="javascript:" class="btn btn-orange mb-3" style="padding: 0.7rem 2rem; margin-right: 1rem;" data-toggle="modal" data-target="#sender">
                <i class="iconfont icon-playlistadd"></i>发件人信息</a>
            <a href="javascript:" class="btn btn-orange mb-3" style="padding: 0.7rem 2rem; margin-right: 1rem;" onclick="CheckIsInstall()">检测是否安装打印插件</a>
