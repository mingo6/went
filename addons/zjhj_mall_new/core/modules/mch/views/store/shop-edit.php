...
<div class="main-body p-3">
    <form class="form auto-submit-form" method="post" autocomplete="off" data-return="<?= $urlManager->createUrl(['mch/store/shop']) ?>">
        ...
        <div class="form-body white-bg border-b-l border-b-r" style="overflow: hidden;">
            ...
            <div class="form-group row mb-5">
                ...
                <div class="col-3">
                    ...
                    <div class="fs-sm mt-3">门店经纬度可以在地图上选择，也可以自己添加</div>
                </div>
                <div class="col-1 text-left">
                ...
                <div class="col-12 text-left">
                    <div style="display: inline-block;vertical-align: top;width: 45%">
                        <div class="form-group row map">
                            <div class="col-9">
                                <div style="color: #A4A9B3">门店经度、门店纬度可通过下面搜索城市和关键字，点击地图上的蓝色点获取</div>
                                ...
                                <div id="container" style="min-width:47.07rem;min-height:23.64rem;"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-3">
                    ...
                    <div class="text-danger mt-3">仅支持1~5的评分</div>
                </div>
                <div class="col-1 text-left">
