...
<div class="main-body p-3" id="app">
    <form class="form" method="post" autocomplete="off">
        ...
        <div class="form-body">
            <div style="color: #D53F3F;">提示： 首页板块可以添加到小程序端，如果没有板块可以点击添加板块； 首页更新小程序端下拉刷新就可以看到。</div>
            <a href="<?= $urlManager->createUrl(['mch/store/home-block-edit']) ?>">
            ...
            <div class="clearfix">
                <div class="module-list" style="height: 540px;overflow-y: scroll">
                ...
                <ol class="edit-box" id="sortList" style="height: 540px;overflow-y: scroll">
    ...
    <div class="content-p white-bg form-horizontal border-7 p-3 mt-3">
        <div class="form-group row" style="margin: 0;">
            <div class="col-12 text-left">
                <div class="text-danger form-error mb-3" style="display: none">错误信息</div>
                <div class="text-success form-success mb-3" style="display: none">成功信息</div>
                <a class="btn btn-default btn-block submit-btn" href="javascript:">保存</a>
            </div>
        </div>
    </div>
</div>
