...
<div class="main-body p-3">
    <form class="form">
        ...
        <div class="form-body white-bg borer-b-l border-b-r">
            <a href="javascript:" data-toggle="modal" data-target="#attrAddModal" class="btn btn-orange mb-3"><i
            ...
            <table class="table table-bordered bg-white">
                ...
                <?php foreach ($attr_list as $index => $item): ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-default attr-update" href="javascript:"><i
                                        class="iconfont icon-bordercolor"></i>修改</a>
                            <a data-id="<?= $item['id'] ?>" class="btn btn-sm btn-default attr-delete" href="javascript:"><i
