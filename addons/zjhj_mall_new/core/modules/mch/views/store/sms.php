        ...
        <div class="form-body white-bg border-b-l border-b-r">
            ...
            <div class="form-group row">
                <div class="col-5 text-left">
                    <p style="color: #A4A9B3">例如：“模板内容: 您有一个新的订单，订单号：${order}”，则填写“order”</p>
                    <p class="text-danger" style="font-weight: bold">注意：目前只支持设置订单号</p>
                </div>
                <div class="col-6 text-left">
                    <p style="color: #A4A9B3">多个请使用英文逗号,分隔</p>
                </div>
            </div>
            <!-- <div class="form-group row">
