...
<div class="main-body p-3" id="app">
    <form class="form auto-submit-form" method="post" autocomplete="off" data-return="<?= $urlManager->createUrl(['mch/store/home-block']) ?>">
        ...
        <div class="form-body white-bg border-b-l border-b-r">
            ...
            <div class="form-group row">
                ...
                <div class="col-12" style="padding-top: calc(.5rem - 1px * 2);color: #A4A9B2"><label class=" col-form-label">注：</label>只放一张图片时小程序端不会对图片裁剪，图片宽度填充屏幕宽度，高度自适应</div>
            </div>
            <div class="form-group row">
                <div class="col-1 text-left">
