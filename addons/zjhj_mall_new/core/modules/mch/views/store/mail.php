                ...
                <div class="col-3">
                    ...
                    <?php else: ?>
                        <input class="form-control" type="text" name="send_pwd"
                               value="<?= $list->send_pwd ?>">
                    <?php endif; ?>
                    <div class="fs-sm mt-3"><a target="_blank" href="http://service.mail.qq.com/cgi-bin/help?subtype=1&&no=1001256&&id=28">什么是授权码？</a></div>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-1 text-left">
                ...
                <div class="col-3">
                    ...
                    <div class="fs-sm mt-3">多个请用英文逗号隔开</div>
                </div>
            </div>
            <!-- <div class="form-group row">
