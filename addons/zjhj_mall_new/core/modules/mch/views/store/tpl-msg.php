    ...
    <form class="form auto-submit-form" method="post" autocomplete="off"
        ...
        <div class="form-body white-bg border-b-l border-b-r">
            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    <div style="color: #F00909">注：因微信限制，每个支付订单最多只能发送<b>3</b>条模板消息，如不需要发送模板消息的请留空。</div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-4">
                    ...
                    <div class="fs-sm text-muted mt-3">
                        ...
                        <a href="javascript:" style="color: #F00909" data-toggle="modal" data-target="#pay_tpl">如何获取支付通知模板消息id</a>
                    </div>
                </div>
                <div class="col-2 text-left">
                ...
                <div class="col-4">
                    ...
                    <div class="fs-sm text-muted mt-3">
                        ...
                        <a href="javascript:" style="color: #F00909" class="fs-sm" data-toggle="modal"
            ...
            <div class="form-group row">
                ...
                <div class="col-4">
                    <input class="form-control mb-3" value="<?= $model->not_pay_tpl ?>" name="not_pay_tpl">
                    <a href="javascript:" style="color: #F00909" class="fs-sm mt-3" data-toggle="modal"
