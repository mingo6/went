...
<div class="main-body p-3">
    <form class="form auto-submit-form" method="post" autocomplete="off">
        ...
        <!-- 基本信息 -->
        <div class="content-p white-bg form-horizontal border-b-l border-b-r mb-3">
            <div class="p-3"><span class="title-line">基本信息</span></div>
            <div class="row p-3">
        ...
        <!-- 支付信息 -->
        <div class="content-p white-bg form-horizontal border-7 mb-3">
            <div class="p-3"><span class="title-line">支付信息</span></div>
            <div class="row p-3">
                <div class="col-4 text-left">
                    <div class="form-group row">
                        <div class="col-3 text-left">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12">
                            <?php if ($wechat_app->cert_pem): ?>
                                <div class="input-hide">
                                    <textarea class="form-control mb-3 mt-3" type="text"
                                              rows="3"
        ...
        <!-- 快递信息 -->
        <div class="content-p white-bg form-horizontal border-7 mb-3">
            <div class="p-3"><span class="title-line">快递信息</span></div>
            <div class="row p-3">
                <div class="col-4 text-left">
                    <div class="form-group row">
                        <div class="col-3 text-left">
                        ...
                        <div class="col-9">
                            <input class="form-control mb-2" type="text" name="kdniao_mch_id"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            ...
                            <div class="text-muted fs-sm mt-2">从发货到自动确认收货的时间</div>
                        </div>
                    </div>
                </div>
                <div class="col-4 text-left">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            ...
                            <div class="text-muted fs-sm mt-2">可以申请售后的时间，<span class="text-danger">注意：分销订单中的已完成订单，只有订单已确认收货，并且时间超过设置的售后天数之后才计入其中！</span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        <!-- 分类信息 -->
        <div class="content-p white-bg form-horizontal border-7 mb-3">
            <div class="p-3"><span class="title-line">分类信息</span></div>
            <div class="row p-3">
                <div class="col-12 text-left">
                    <div class="form-group row">
                        ...
                        <div class="col-11" style="padding-top: calc(.5rem - 1px * 2);">
                            <label class="custom-control custom-radio">
        ...
        <!-- 会员信息 -->
        <div class="content-p white-bg form-horizontal border-7 mb-3">
            <div class="p-3"><span class="title-line">会员信息</span></div>
            <div class="row p-3">
                <div class="col-4 text-left">
                    <div class="form-group row">
                        <div class="col-3 text-left">
                ...
                <div class="col-8 text-left">
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            ...
                            <div class="text-muted fs-sm mt-2">积分使用规则用于用户结算页说明显示，为了更好体验字数最好不要超过80字</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- 底部信息 -->
        <div class="content-p white-bg form-horizontal border-7 mb-3">
            <div class="p-3"><span class="title-line">底部信息</span></div>
            <div class="row p-3">
                <div class="col-4 text-left">
                    <div class="form-group row">
                        <div class="col-3 text-left">
        ...
        <!-- 商城首页公告 -->
        <div class="content-p white-bg form-horizontal border-7 mb-3">
            <div class="p-3"><span class="title-line">商城首页公告</span></div>
            <div class="row p-4">
                <div class="col-12 text-left">
                    <div class="form-group row">
                        <div class="col-1 text-left">
        ...
        <!-- 商城首页公告 -->
        <div class="content-p white-bg form-horizontal border-7 p-3">
