            ...
            <div class="main-nav" flex="cross:center dir:left box:first">
                <div>
                    <nav class="breadcrumb rounded-0 mb-0" flex="cross:center">
                        ...
                        <a class="breadcrumb-item" href="<?= $urlManager->createUrl(['mch/store/index']) ?>">商品管理</a>
                        <span class="breadcrumb-item active"><?= $this->title ?></span>
                    </nav>
                </div>
            </div>
        ...
        <div class="form-body white-bg border-b-l border-b-r">
            ...
            <div class="mb-3 clearfix">
                <div class="float-left">
                    <a href="<?= $urlManager->createUrl(['mch/goods/goods-edit']) ?>" class="btn btn-orange"><i
                                class="iconfont icon-playlistadd"></i>添加商品</a>
                    <a href="javascript:void(0)" class="btn btn-orange batch"
                    ...
                    <a href="javascript:void(0)" class="btn btn-orange batch"
                       ...
                       data-type="2">批量删除</a>
                    <a href="javascript:" data-toggle="modal" data-target="#attrAddModal" class="btn btn-orange">批量设置积分</a>
                    <div class="dropdown float-right ml-2">
                        <button class="btn btn-orange dropdown-toggle" type="button" id="dropdownMenuButton"
                    ...
                    <tr>
                        ...
                        <td class="nowrap">
                            <a class="btn btn-sm btn-default"
                               href="<?= $urlManager->createUrl(['mch/goods/goods-coupon', 'id' => $goods->id]) ?>">优惠券管理</a>
                            <a class="btn btn-sm btn-default"
                               href="<?= $urlManager->createUrl(['mch/goods/goods-edit', 'id' => $goods->id]) ?>">修改</a>
                            <a class="btn btn-sm btn-default copy" data-clipboard-text="/pages/goods/goods?id=<?= $goods->id ?>"
                               href="javascript:" hidden>复制链接</a>
                            <a class="btn btn-sm btn-default del"
