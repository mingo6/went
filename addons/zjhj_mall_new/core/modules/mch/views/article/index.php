            ...
            <div class="main-nav" flex="cross:center dir:left box:first">
                <div>
                    <nav class="breadcrumb rounded-0 mb-0" flex="cross:center">
                        ...
                        <a class="breadcrumb-item" href="<?= $urlManager->createUrl(['mch/order/index']) ?>">系统文章</a>
        ...
        <div class="form-body white-bg border-7">
            <?php if ($cat_id != 1): ?>
                <a href="<?= $urlManager->createAbsoluteUrl(['mch/article/edit', 'cat_id' => 2]) ?>"
                   class="btn btn-orange mb-3"><i class="iconfont icon-playlistadd"></i>添加文章</a>
            <?php endif; ?>
                ...
                <?php foreach ($list as $item): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if ($cat_id != 1): ?>
                                <a class="btn btn-sm btn-orange copy"
