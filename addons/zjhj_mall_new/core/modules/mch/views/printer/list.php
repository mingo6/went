...
<div class="main-body p-3">
    <form class="form">
            ...
            <div class="main-nav" flex="cross:center dir:left box:first">
                <div>
                    <nav class="breadcrumb rounded-0 mb-0" flex="cross:center">
                        ...
                        <a class="breadcrumb-item" href="<?= $urlManager->createUrl(['mch/order/index']) ?>">小票打印机</a>
                        <span class="breadcrumb-item active"><?= $this->title ?></span>
                    </nav>
                </div>
            </div>
        ...
        <div class="form-body white-bg border-7">
            <a class="btn btn-orange mb-3" href="<?= $urlManager->createUrl(['mch/printer/edit']) ?>">添加打印机</a>
                <table class="table table-bordered bg-white">
                    ...
                    <?php foreach($list as $index=>$value):?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-orange" href="<?=$urlManager->createUrl(['mch/printer/edit','id'=>$value['id']])?>">编辑</a>
