...
myyapp.controller('ctr',['$scope',function($scope){
		...
		data : [
			{
				...
				actimg: window.sysinfo.siteroot+'/addons/zjhj_mall/core/web/statics/images/thank.png',
				url : '',
                type : 'url',
			},
			{
	...
	$scope.saveData = function(){
        ...
        $.ajax({
            type: 'POST',
            dataType : 'json',
            url: window.sysinfo.siteroot + '/addons/zjhj_mall/core/web/index.php?r=mch%2Fsite%2Fmodule%2Fsavebar',
            data: {_csrf:_csrf, data : $scope.items, tid : tempid },
