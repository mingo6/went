...
if(!file_exists($configfile)) {
	if(file_exists(IA_ROOT . '/install.php')) {
		...
		echo "&nbsp;&nbsp;<a href='http://www.qinhantangtop.com' style='font-size:12px' target='_blank'>Power by WE7 " . IMS_VERSION . " &nbsp;勤瀚堂公众平台自助开源引擎</a>";
		exit();
	} else {
		header('Content-Type: text/html; charset=utf-8');
...
if(!empty($_GPC['isminiapp'])){
	$_W['container'] = 'miniapp';
}else{
