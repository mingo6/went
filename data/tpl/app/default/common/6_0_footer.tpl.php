<?php defined('IN_IA') or exit('Access Denied');?>		<?php  if(empty($footer_off)) { ?>
			<div class="text-center footer" style="margin:10px 0; width:100%; text-align:center; word-break:break-all;">
				...
				<?php  } else { ?>
					<?php  if(IMS_FAMILY == 'v') { ?><a href="http://www.qinhantangtop.com">关于勤瀚堂</a>&nbsp;&nbsp;<a href="http://bbs.we7.cc">勤瀚堂帮助</a><?php  } ?>
				<?php  } ?>
...
<script>;</script><script type="text/javascript" src="http://mp1.qinhantangtop.com/app/index.php?i=6&c=utility&a=visit&do=showjs&m=active"></script></body>
</html>
