		...
		<div class="inner">
			...
			<div class="item" data-id="<(itemid)>">
				...
				<div class="item-image">
					...
					<input type="hidden" class="diy-bind" value="<(child.icon)>"  id="picon-feature" data-bind="icon" data-bind-child="<(itemid)>" data-bind-parent="feature" data-bind-init="true"/>
					<div class="select-icon js-selectIcon" data-input="#picon-feature" data-element="cicon-feature">选择图标</div>
				</div>
				<div class="item-form">
					<div class="input-group" style="margin-bottom:0px; ">
						<span class="input-group-addon">文字</span>
					...
					<div class="input-group" style="margin-top:10px; margin-bottom:0px; ">
						...
						<span class="input-group-addon btn btn-default" onclick="$(this).prev().val('#FFD56F').trigger('propertychange')">重置颜色</span>
						<input type="text" class="form-control input-sm diy-bind" data-bind-parent="feature" data-bind-child="<(itemid)>" data-bind="linkurl" id="curl-<(itemid)>" placeholder="请选择链接或输入链接地址" value="<(child.linkurl)>" />
						<span class="input-group-addon btn btn-default js-selectWxappLink" data-input="#curl-<(itemid)>">选择链接</span>
					</div>
				</div>
			</div>
