...
<form action="./wagent.php?" class="form-horizontal form-filter" id="form1">
	...
	<div class="form-group">
		...
		<div class="col-sm-9 col-xs-12">
			<div class="btn-group">
				<a href="<?php  echo iurl('merchant/getcash/list', array('status' => 0));?>" class="btn <?php  if($status == 0) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">全部</a>
				<a href="<?php  echo iurl('merchant/getcash/list', array('status' => 2));?>" class="btn <?php  if($status == 2) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">申请中</a>
				<a href="<?php  echo iurl('merchant/getcash/list', array('status' => 1));?>" class="btn <?php  if($status == 1) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">提现成功</a>
				<a href="<?php  echo iurl('merchant/getcash/list', array('status' => 3));?>" class="btn <?php  if($status == 3) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">已撤销</a>
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-9 col-xs-12 js-daterange" data-form="#form1">
			<div class="btn-group">
				<a href="<?php  echo iurl('merchant/getcash/list', array('days' => -2));?>" class="btn <?php  if($days == -2) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">不限</a>
				<a href="<?php  echo iurl('merchant/getcash/list', array('days' => 7));?>" class="btn <?php  if($days == 7) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">近一周</a>
				<a href="<?php  echo iurl('merchant/getcash/list', array('days' => 30));?>" class="btn <?php  if($days == 30) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">近一月</a>
				<a href="<?php  echo iurl('merchant/getcash/list', array('days' => 90));?>" class="btn <?php  if($days == 90) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">近三月</a>
