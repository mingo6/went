			...
			<div class="product-info">
				...
				<div class="product-display hide">
						...
						<table class="table">
							...
							<?php  if(is_array($goods_all[$order['id']])) { foreach($goods_all[$order['id']] as $goods) { ?>
								<tr>
									...
									<td class="goods-price">yen<?php  echo $goods['goods_unit_price'];?></td>
									<td class="goods-num">x<?php  echo $goods['goods_num'];?></td>
									<td class="total-price">yen<?php  echo $goods['goods_price'];?></td>
								</tr>
							<?php  } } ?>
							</tbody>
						</table>
					...
					<?php  if($order['data']['extra_fee']) { ?>
						<?php  if(is_array($order['data']['extra_fee'])) { foreach($order['data']['extra_fee'] as $extra_fee) { ?>
							<div class="list-item clearfix">
								...
								<span class="pull-right">yen<?php  echo $extra_fee['fee'];?></span>
							</div>
						<?php  } } ?>
					<?php  } ?>
					...
					<div class="list-item clearfix">
						...
						<span class="pull-right">yen<?php  echo $order['box_price'];?></span>
					</div>
					<?php  } ?>
					<?php  if($order['pack_fee'] > 0) { ?>
					<div class="list-item clearfix">
						<span class="pull-left">包装费</span>
						<span class="pull-right">yen<?php  echo $order['pack_fee'];?></span>
					</div>
					<?php  } ?>
					...
					<div class="charge-info">
						...
						<div class="total clearfix">
							...
							<div class="pull-right"><span class="highlight">yen<?php  echo $order['store_final_fee'];?></span></div>
						</div>
						<?php  if($order['order_plateform'] == 'eleme') { ?>
							<div class="total clearfix">
								<div class="pull-left"><span class="highlight">饿了么店铺收入</span></div>
								<div class="pull-right"><span class="highlight">yen<?php  echo $order['eleme_store_final_fee'];?></span></div>
							</div>
						<?php  } else if($order['order_plateform'] == 'meituan') { ?>
							<div class="total clearfix">
								<div class="pull-left"><span class="highlight">美团店铺收入</span></div>
								<div class="pull-right"><span class="highlight">yen<?php  echo $order['meituan_store_final_fee'];?></span></div>
							</div>
						<?php  } ?>
					</div>
				</div>
