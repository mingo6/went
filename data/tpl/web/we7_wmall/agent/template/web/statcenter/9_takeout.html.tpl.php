...
<form action="./wagent.php" class="form-horizontal form-filter" id="form1">
	...
	<div class="form-group">
		...
		<div class="col-sm-9 col-xs-12 js-daterange" data-form="#form1">
			<div class="btn-group">
				<a href="<?php  echo iurl('statcenter/takeout/index', array('days' => 0));?>" class="btn <?php  if(!$days) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">今天</a>
				<a href="<?php  echo iurl('statcenter/takeout/index', array('days' => 7));?>" class="btn <?php  if($days == 7) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">最近7天</a>
				<a href="<?php  echo iurl('statcenter/takeout/index', array('days' => 30));?>" class="btn <?php  if($days == 30) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">最近30天</a>
		...
		<div class="panel-body table-responsive">
			...
			<?php  if(is_array($records)) { foreach($records as $record) { ?>
				<tr>
					...
					<td><span class="text-success-danger">￥<?php  echo $record['plateform_delivery_fee'];?></span></td>
					...
					<td>￥<?php  echo $record['agent_final_fee'];?></td>
				</tr>
			<?php  } } ?>
			</tbody>
		</table>
