                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8 col-lg-9">
                        ...
                        <select name="status" class="form-control" style="float:left">
                            ...
                            <option value="<?php  echo $this::$KJ_STATUS_XD?>" <?php  if($status == $this::$KJ_STATUS_XD) { ?> selected="selected" <?php  } ?>>已下单</option>
                            <option value="<?php  echo $this::$KJ_STATUS_GM?>" <?php  if($status == $this::$KJ_STATUS_GM) { ?> selected="selected" <?php  } ?> >已支付</option>
                            <option value="<?php  echo $this::$KJ_STATUS_YFH?> <?php  if($status == $this::$KJ_STATUS_YFH) { ?> selected="selected" <?php  } ?>">已发货</option>
                        </select>
