...
<div class="clearfix">
	...
	<div class="activity-shop-card">
		...
		<span class="title">满减配送费</span>
		<span class="sub-title">配送费满足条件后可享受减优惠</span>
		<span class="count">已有 <span class="num"><?php  echo intval($stats['deliveryFeeDiscount']['num']);?></span> 商户创建</span>
		<?php  if(!empty($activitys['deliveryFeeDiscount'])) { ?>
		<a href="<?php  echo iurl('store/activity/deliveryFeeDiscount');?>" class="btn btn-danger">查看</a>
		<?php  } else { ?>
		<a href="<?php  echo iurl('store/activity/deliveryFeeDiscount');?>" class="btn btn-primary">创建</a>
		<?php  } ?>
	</div>
</div>
