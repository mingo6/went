...
<div class="nav slimscroll">
	...
	<ul class="menu-item">
		<li <?php  if($_W['_op'] == 'setting') { ?>class="active"<?php  } ?>>
			<a href="<?php  echo iurl('store/tangshi/setting');?>">店内点餐设置 </a>
		</li>
	</ul>
	<div class="menu-header">呼叫服务</div>
	<ul class="menu-item">
		<li <?php  if($_W['_op'] == 'call') { ?>class="active"<?php  } ?>>
			<a href="<?php  echo iurl('store/tangshi/call');?>">呼叫记录</a>
		</li>
	</ul>
