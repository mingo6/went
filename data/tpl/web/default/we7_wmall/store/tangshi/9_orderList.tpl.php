			...
			<div class="col-sm-9 col-xs-12">
				<div class="btn-group">
					<div class="btn-group">
						...
						<a href="<?php  echo ifilter_url('pay_type:finishMeal');?>" class="btn <?php  if($pay_type == 'finishMeal') { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">餐后支付</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="panel-order">
			...
			<div class="product-info">
				<p class="product-title">
					...
					<span class="pull-right greenest toggle-product">收起 <i class="fa fa-angle-up"></i></span>
				</p>
