...
<form action="./index.php" class="form-horizontal form-filter">
	...
	<div class="form-group form-inline">
		...
		<div class="col-sm-9 col-xs-12">
			...
			<input type="text" name="keyword" value="<?php  echo $keyword;?>" class="form-control" placeholder="输入用户名/手机号/订单编号" style="margin-left: 5px;">
...
<form action="" class="form-table form" method="post">
	<?php  if(!empty($comments)) { ?>
										...
										<div class="col-sm-10 col-md-10 col-lg-10 comment-item-right">
											...
											<div class="comment-main">
												...
												<div class="input-area">
													...
													<a href="<?php  echo iurl('store/service/comment/status', array('comment_id' => $comment['id'], 'status' => 1))?>" class="btn btn-success js-post">审核通过</a>
													<a href="<?php  echo iurl('store/service/comment/status', array('comment_id' => $comment['id'], 'status' => 2))?>" class="btn btn-danger js-post">未通过</a>
													<?php  } ?>
												</div>
												<div class="arrow"></div>
											</div>
		...
		<div class="btn-region clearfix">
			<div class="pull-left">
				<a href="<?php  echo iurl('store/service/comment/group')?>" class="btn btn-primary js-batch" data-batch="modal">批量回复</a>
				<a href="<?php  echo iurl('store/service/comment/status', array('status' => 1))?>" class="btn btn-success js-batch" data-confirm="确定评论通过审核吗">审核通过</a>
				<a href="<?php  echo iurl('store/service/comment/status', array('status' => 2))?>" class="btn btn-danger js-batch" data-confirm="确定评论未通过审核吗">未通过</a>
			</div>
