...
<form class="form-horizontal form-validate" id="form-changes" action="<?php  echo iurl('agent/agent/changes');?>" method="post" enctype="multipart/form-data">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">代理信息</label>
					<div class="col-sm-9 col-xs-12">
						&nbsp;&nbsp;<span><?php  echo $agent['title'];?>/<?php  echo $agent['mobile'];?></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">当前余额</label>
					<div class="col-sm-9 col-xs-12"><span><?php  echo $agent['amount'];?>元</span></div>
				</div>
				<div class="form-group">
...
<?php  if($op == 'cancel') { ?>
<form class="form-horizontal form-validate" id="form-cancel" action="<?php  echo iurl('agent/getcash/cancel');?>" method="post" enctype="multipart/form-data">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">代理信息</label>
					<div class="col-sm-9 col-xs-12">
						<img width="50" height="50" src="<?php  echo tomedia($log['account']['avatar'])?>" alt="">
						&nbsp;&nbsp;<span><?php  echo $agent['title'];?>/<?php  echo $agent['mobile'];?></span>
					</div>
				</div>
				<div class="form-group">
