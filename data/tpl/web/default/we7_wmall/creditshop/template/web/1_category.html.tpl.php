				...
				<table class="table table-hover">
					...
					<?php  if(is_array($categorys)) { foreach($categorys as $category) { ?>
						<tr>
							...
							<td>
								<input type="checkbox" class="js-checkbox" data-on-text="显示" data-off-text="隐藏" data-href="<?php  echo iurl('creditshop/category/status', array('id' => $category['id']));?>" data-name="status" value="1" <?php  if($category['status'] == 1) { ?>checked<?php  } ?>>
							</td>
							<td class="text-right">
...
<div class="page clearfix">
	...
	<form class="form-horizontal form form-validate" id="form1" action="" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="radio radio-inline">
					<input type="radio" name="isrecommand" value="1" id="isrecommand-1" <?php  if($category['isrecommand'] == 1) { ?>checked<?php  } ?>>
					<label for="isrecommand-1">是</label>
				</div>
				<div class="radio radio-inline">
					<input type="radio" name="isrecommand" value="0" id="isrecommand-0" <?php  if(!$category['isrecommand']) { ?>checked<?php  } ?>>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="radio radio-inline">
					<input type="radio" name="status" value="1" id="status-1" <?php  if($category['status'] == 1) { ?>checked<?php  } ?>>
					<label for="status-1">启用</label>
				</div>
				<div class="radio radio-inline">
					<input type="radio" name="status" value="0" id="status-0" <?php  if(!$category['status']) { ?>checked<?php  } ?>>
