	...
	<form class="form-horizontal form form-validate" id="form1" action="" method="post" enctype="multipart/form-data">
			...
			<div class="toggle-pane <?php  if($serve_fee['fee_takeout']['type'] == 1 || empty($serve_fee['fee_takeout']['type'])) { ?>active<?php  } ?>" id="fee-takeout-1">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<div class="col-sm-9 col-xs-12">
							<div class="checkbox checkbox-inline">
								<input type="checkbox" value="price" name="fee_takeout[items_yes][]" id="fee-takeout-items-price" <?php  if(!empty($serve_fee['fee_takeout']['items_yes']) && in_array('price', $serve_fee['fee_takeout']['items_yes'])) { ?>checked<?php  } ?>>
								<label for="fee-takeout-items-price">商品费用</label>
							</div>
							<div class="checkbox checkbox-inline">
								<input type="checkbox" value="box_price" name="fee_takeout[items_yes][]" id="fee-takeout-items-box-price" <?php  if(!empty($serve_fee['fee_takeout']['items_yes']) && in_array('box_price', $serve_fee['fee_takeout']['items_yes'])) { ?>checked<?php  } ?>>
								<label for="fee-takeout-items-box-price">餐盒费</label>
							</div>
							<div class="checkbox checkbox-inline">
								<input type="checkbox" value="pack_fee" name="fee_takeout[items_yes][]" id="fee-takeout-items-pack-fee" <?php  if(!empty($serve_fee['fee_takeout']['items_yes']) && in_array('pack_fee', $serve_fee['fee_takeout']['items_yes'])) { ?>checked<?php  } ?>>
								<label for="fee-takeout-items-pack-fee">包装费</label>
							</div>
							<div class="checkbox checkbox-inline">
								<input type="checkbox" value="delivery_fee" name="fee_takeout[items_yes][]" id="fee-takeout-items-delivery-fee" <?php  if(!empty($serve_fee['fee_takeout']['items_yes']) && in_array('delivery_fee', $serve_fee['fee_takeout']['items_yes'])) { ?>checked<?php  } ?>>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<div class="col-sm-9 col-xs-12">
							<div class="checkbox checkbox-inline">
								<input type="checkbox" value="store_discount_fee" name="fee_takeout[items_no][]" id="fee-takeout-items-discount" <?php  if(!empty($serve_fee['fee_takeout']['items_yes']) && in_array('store_discount_fee', $serve_fee['fee_takeout']['items_no'])) { ?>checked<?php  } ?>>
			...
			<div class="toggle-pane <?php  if($serve_fee['fee_selfDelivery']['type'] == 1 || empty($serve_fee['fee_selfDelivery']['type'])) { ?>active<?php  } ?>" id="fee-selfDelivery-1">
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<div class="col-sm-9 col-xs-12">
							<div class="checkbox checkbox-inline">
								<input type="checkbox" value="price" name="fee_selfDelivery[items_yes][]" id="fee-selfDelivery-items-price" <?php  if(!empty($serve_fee['fee_selfDelivery']['items_yes']) && in_array('price', $serve_fee['fee_selfDelivery']['items_yes'])) { ?>checked<?php  } ?>>
								<label for="fee-selfDelivery-items-price">商品费用</label>
							</div>
							<div class="checkbox checkbox-inline">
								<input type="checkbox" value="box_price" name="fee_selfDelivery[items_yes][]" id="fee-selfDelivery-items-box-price" <?php  if(!empty($serve_fee['fee_selfDelivery']['items_yes']) && in_array('box_price', $serve_fee['fee_selfDelivery']['items_yes'])) { ?>checked<?php  } ?>>
								<label for="fee-selfDelivery-items-box-price">餐盒费</label>
							</div>
							<div class="checkbox checkbox-inline">
								<input type="checkbox" value="pack_fee" name="fee_selfDelivery[items_yes][]" id="fee-selfDelivery-items-pack-fee" <?php  if(!empty($serve_fee['fee_selfDelivery']['items_yes']) && in_array('pack_fee', $serve_fee['fee_selfDelivery']['items_yes'])) { ?>checked<?php  } ?>>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<div class="col-sm-9 col-xs-12">
							<div class="checkbox checkbox-inline">
								<input type="checkbox" value="store_discount_fee" name="fee_selfDelivery[items_no][]" id="fee-selfDelivery-items-discount" <?php  if(!empty($serve_fee['fee_selfDelivery']['items_yes']) && in_array('store_discount_fee', $serve_fee['fee_selfDelivery']['items_no'])) { ?>checked<?php  } ?>>
			...
			<div class="toggle-pane <?php  if($serve_fee['fee_instore']['type'] == 1 || empty($serve_fee['fee_instore']['type'])) { ?>active<?php  } ?>" id="fee-instore-1">
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<div class="col-sm-9 col-xs-12">
							<div class="checkbox checkbox-inline">
								<input type="checkbox" value="price" name="fee_instore[items_yes][]" id="fee-instore-items-price" <?php  if(!empty($serve_fee['fee_instore']['items_yes']) && in_array('price', $serve_fee['fee_instore']['items_yes'])) { ?>checked<?php  } ?>>
								<label for="fee-instore-items-price">商品费用</label>
							</div>
							<div class="checkbox checkbox-inline">
								<input type="checkbox" value="serve_fee" name="fee_instore[items_yes][]" id="fee-instore-items-serve-fee" <?php  if(!empty($serve_fee['fee_instore']['items_yes']) && in_array('serve_fee', $serve_fee['fee_instore']['items_yes'])) { ?>checked<?php  } ?>>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<div class="col-sm-9 col-xs-12">
							<div class="checkbox checkbox-inline">
								<input type="checkbox" value="store_discount_fee" name="fee_instore[items_no][]" id="fee-instore-items-discount" <?php  if(!empty($serve_fee['fee_instore']['items_yes']) && in_array('store_discount_fee', $serve_fee['fee_instore']['items_no'])) { ?>checked<?php  } ?>>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12 toggle-tabs" data-content=".get-cash-period-type">
				<div class="radio radio-inline">
					<input type="radio" value="0" name="get_cash_period" id="get_cash_period-0" <?php  if($serve_fee['get_cash_period'] == 0 || empty($serve_fee['get_cash_period'])) { ?>checked<?php  } ?>>
					<label for="get_cash_period-0" class="toggle-role" data-target="get_cash_period-0">管理员审核</label>
					<div class="help-block"></div>
				</div>
				<div class="radio radio-inline">
					<input type="radio" value="1" name="get_cash_period" id="get_cash_period-1" <?php  if($serve_fee['get_cash_period'] == 1) { ?>checked<?php  } ?>>
