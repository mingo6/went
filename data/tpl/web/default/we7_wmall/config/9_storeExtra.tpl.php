	...
	<form class="form-horizontal form form-validate" id="form1" action="" method="post" enctype="multipart/form-data" >
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-9 col-md-9">
				...
				<div class="radio radio-inline">
					<input type="radio" name="auto_handel_order" id="auto-handel-order-0" value="0" <?php  if(!$extra['auto_handel_order']) { ?>checked<?php  } ?>>
					<label for="auto-handel-order-0">不自动接单</label>
				</div>
				<div class="radio radio-inline">
					<input type="radio" name="auto_handel_order" id="auto-handel-order-2" value="2" <?php  if($extra['auto_handel_order'] == 2) { ?>checked<?php  } ?>>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="input-group">
					...
					<input type="number" name="store_bear_deliveryprice" class="form-control" value="<?php  echo $extra['delivery_extra']['store_bear_deliveryprice'];?>">
...
此项设置的费用将进入平台的收益，与配送员的订单提成没有关系</span>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="radio radio-inline">
					<input type="radio" name="delivery_free_bear" id="delivery_free_bear-plateform" value="plateform" <?php  if($extra['delivery_extra']['delivery_free_bear'] == 'plateform' || !$extra['delivery_extra']['delivery_free_bear']) { ?>checked<?php  } ?>>
					<label for="delivery_free_bear-plateform">平台</label>
				</div>
				<div class="radio radio-inline">
					<input type="radio" name="delivery_free_bear" id="delivery_free_bear-store" value="store" <?php  if($extra['delivery_extra']['delivery_free_bear'] == 'store') { ?>checked<?php  } ?>>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				...
				<div class="help-block">如需开启附加费,请点击现在文字为关闭的按钮,文字显示为开启时,开启成功</div>
			</div>
		</div>
		<div class="form-group">
