...
<form action="./index.php" class="form-horizontal form-filter">
	...
	<div class="form-group">
		...
		<div class="col-sm-9 col-xs-12">
			<div class="btn-group">
				<a class="btn <?php  if(!$order_status) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>" href="<?php  echo iurl('cutPrice/order/list')?>">不限</a>
				<!--<a class="btn <?php  if($order_status == 0) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>" href="<?php  echo iurl('cutPrice/order/list', array('order_status' => 0))?>">待支付</a>-->
				<a class="btn <?php  if($order_status == 1) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>" href="<?php  echo iurl('cutPrice/order/list', array('order_status' => 1))?>">待发货</a>
				<a class="btn <?php  if($order_status == 2) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>" href="<?php  echo iurl('cutPrice/order/list', array('order_status' => 2))?>">待收货</a>
				<a class="btn <?php  if($order_status == 3) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>" href="<?php  echo iurl('cutPrice/order/list', array('order_status' => 3))?>">待评价</a>
				<a class="btn <?php  if($order_status == 4) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>" href="<?php  echo iurl('cutPrice/order/list', array('order_status' => 4))?>">已完成</a>
			</div>
		</div>
	</div>
	<div class="form-group">
