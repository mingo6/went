...
<div class="page clearfix">
	<form class="form-horizontal form form-validate" id="form1" action="" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label class="col-xs-12 col-sm-3 col-md-2 control-label">首页显示商品个数</label>
			<div class="col-sm-9 col-xs-12">
				<input type="text" name="home_number" value="<?php  echo $config_bargain['home_number'];?>" class="form-control" placeholder="请输入首页天天特价商品显示个数" required="true">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<?php  echo tpl_ueditor('agreement', $config_bargain['agreement']);?>
			</div>
		</div>
		<h3>分享设置</h3>
		<div class="form-group">
