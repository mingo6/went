...
<form action="" class="form-table form form-validate" method="post">
	<div class="panel panel-table">
		<div class="panel-heading">
			<a href="<?php  echo iurl('allgroupgoods/category/post');?>" class="btn btn-primary btn-sm">添加新商品分类</a>
		</div>
				...
				<table class="table table-hover">
					...
					<?php  if(is_array($categorys)) { foreach($categorys as $category) { ?>
						<tr>
							...
							<td class="text-right">
								<a href="<?php  echo iurl('allgroupgoods/category/post', array('id' => $category['id']))?>" class="btn btn-default btn-sm" title="编辑" data-toggle="tooltip" data-placement="top" ><i class="fa fa-edit"> </i> 编辑</a>
								<a href="<?php  echo iurl('allgroupgoods/category/del', array('id' => $category['id']))?>" class="btn btn-default btn-sm js-remove" data-confirm="确定删除该商品分类?"><i class="fa fa-times"> </i> 删除</a>
							</td>
						</tr>
					<?php  } } ?>
				</table>
