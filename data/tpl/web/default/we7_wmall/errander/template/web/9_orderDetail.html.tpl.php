		...
		<div class="panel panel-display">
			...
			<div class="panel-body">
				<table class="table">
					...
					<?php  if(is_array($order['data']['fees'])) { foreach($order['data']['fees'] as $item) { ?>
						<tr>
							<td width="130"><?php  echo $item['title'];?>：</td>
							<td>
								<span><?php  echo $item['fee_cn'];?></span>
							</td>
						</tr>
					<?php  } } ?>
					<tr>
					...
					<tr>
						<td width="130">代理商收入：</td>
						<td>
							+￥ <?php  echo $order['plateform_serve_fee'];?> = <?php  echo $order['plateform_serve']['note'];?>
						</td>
					</tr>
					<tr>
