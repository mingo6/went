	...
	<?php  if($filter_type == 'process' || $filter_type == 'all') { ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="btn-group">
					<div class="btn-group">
						<a href="<?php  echo ifilter_url('order_type:0');?>" class="btn <?php  if(empty($order_type)) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">不限</a>
						<?php  if(is_array($errander_type)) { foreach($errander_type as $item) { ?>
						<a href="<?php  echo ifilter_url('order_type:'.$item['value']);?>" class="btn <?php  if($order_type == $item['value']) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>"><?php  echo $item['errander_name'];?></a>
						<?php  } } ?>
					</div>
				</div>
			</div>
...
<div class="clearfix order-list">
	...
	<div class="col-md-8">
		...
		<div class="panel-order">
			...
			<?php  } ?>
			<div class="user-info">
				<span class="highlight">收货人：<?php  if(!empty($order['accept_username'])) { ?><?php  echo $order['accept_username'];?>(<?php  echo $order['accept_sex'];?>)<?php  } else { ?>未填写,直接电话联系<?php  } ?></span>
			...
			<div class="product-info">
				...
				<div class="product-display">
					<div class="list-item clearfix">
						...
						<span class="pull-right">¥<?php  if(!empty($order['distance'])) { ?><?php  echo $order['distance'];?>km<?php  } else { ?>未知<?php  } ?></span>
					</div>
					...
					<?php  if($order['discount_fee'] > 0) { ?>
						<div class="list-item clearfix">
							...
							<span class="pull-right">¥<?php  echo $order['discount_fee'];?></span>
						</div>
					<?php  } ?>
					<?php  if($order['delivery_tips'] > 0) { ?>
						<div class="list-item clearfix">
							<span class="pull-left">小费</span>
							<span class="pull-right">¥<?php  echo $order['delivery_tips'];?></span>
						</div>
					<?php  } ?>
