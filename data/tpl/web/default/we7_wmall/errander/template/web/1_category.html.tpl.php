	...
	<form class="form-horizontal form form-validate" id="form1" action="" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				...
				<div class="help-block">例如: 修家电</div>
			</div>
		</div>
		...
		<div class="toggle-content category-type">
			<div class="toggle-pane <?php  if($item['type'] != 'multiaddress') { ?>active<?php  } ?>" id="category-type-1">
				<div class="form-group">
				...
				<table class="table table-hover">
					...
					<?php  if(is_array($categorys)) { foreach($categorys as $item) { ?>
						<tr>
							...
							<td><?php  if($item['type'] == 'buy') { ?>家政服务<?php  } else if($item['type'] == 'delivery') { ?>家电维修<?php  } else { ?>废品回收<?php  } ?></td>
