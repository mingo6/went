...
<form action="" class="form-table form" method="post">
	<div class="panel panel-table">
		<div class="panel-heading">
			<a href="<?php  echo iurl('dashboard/notice/post');?>" class="btn btn-primary btn-sm">添加公告页</a>
		</div>
			...
			<?php  } else { ?>
				...
				<div class="btn-region clearfix">
					<div class="pull-left">
						...
						<?php  if($_W['is_agent']) { ?>
							<a href="<?php  echo iurl('dashboard/notice/noticeagent')?>" class="btn btn-default btn-sm js-batch" data-batch="modal">批量操作</a>
						<?php  } ?>
					</div>
