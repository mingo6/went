				...
				<table class="table table-hover">
					...
					<tr>
						...
						<td style="text-align:right;">
							<a href="javascript:;" class="btn btn-default btn-sm js-clip" data-href="<?php  echo $item['wxapp_link'];?>">小程序链接</a>
							<a href="javascript:;" class="btn btn-default btn-sm js-clip" data-href="<?php  echo $item['link'];?>">公众号链接</a>
				...
				<table class="table table-hover table-bordered">
					...
					<?php  if(is_array($category['slide'])) { foreach($category['slide'] as $slide) { ?>
						<tr>
							...
							<td>
								<div class="input-group">
									<input type="text" value="<?php  echo $slide['wxapp_link'];?>" name="wxapp_links[]" class="form-control">
									<span class="input-group-btn">
			...
			<div class="col-sm-9 col-xs-9 col-md-9">
				<table class="table table-hover table-bordered">
					...
					<tr>
						...
						<td>
							<div class="input-group">
								<input type="text" value="<?php  echo $category['nav'][0]['wxapp_link'];?>" name="nav_wxapp_links[]" class="form-control">
								<span class="input-group-btn">
									<button class="btn btn-default btn-wxapp-links" type="button">选择小程序跳转连接</button>
								</span>
							</div>
					...
					<tr>
						...
						<td>
							<div class="input-group">
								<input type="text" value="<?php  echo $category['nav'][1]['wxapp_link'];?>" name="nav_wxapp_links[]" class="form-control">
								<span class="input-group-btn">
									<button class="btn btn-default btn-wxapp-links" type="button">选择小程序跳转连接</button>
								</span>
							</div>
