...
-->
					...
					<td>
						<input type="checkbox" class="js-checkbox" data-href="<?php  echo iurl('deliveryer/plateform/perm', array('id' => $item['id'], 'fields' => 'is_takeout', 'value' => $item['is_takeout']));?>" value="1" <?php  if($item['is_takeout'] == 1) { ?>checked<?php  } ?>>
					</td>
					<?php  if(check_plugin_perm('errander')) { ?>
						<td>
							<input type="checkbox" class="js-checkbox" data-href="<?php  echo iurl('deliveryer/plateform/perm', array('id' => $item['id'], 'fields' => 'is_errander', 'value' => $item['is_errander']));?>" value="1" <?php  if($item['is_errander'] == 1) { ?>checked<?php  } ?>>
						</td>
					<?php  } ?>
					<td>
						...
						<?php  } ?>
						<?php  if($item['type']=='buy') { ?>家政服务员
						<?php  } else if($item['type']=='delivery') { ?>家电维修员
						<?php  } else if($item['type']=='pickup') { ?>废品回收员
						<?php  } else { ?>社区跑腿员
						<?php  } ?>
					</td>
					<td class="text-right">
...
<div class="page clearfix">
	...
	<form class="form-horizontal form form-validate" id="form1" action="" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label class="col-xs-12 col-sm-3 col-md-2 control-label">跑腿人员类型</label>
			<div class="col-sm-9 col-xs-12">
				<div class="radio radio-inline">
					<input type="radio" name="type" id="type-1" value="buy" <?php  if($deliveryer['type'] == 'buy' || !$deliveryer['type']) { ?>checked<?php  } ?>>
					<label for="type-1">家政服务员</label>
				</div>
				<div class="radio radio-inline">
					<input type="radio" name="type" id="type-2" value="delivery" <?php  if($deliveryer['type'] == 'delivery') { ?>checked<?php  } ?>>
					<label for="type-2">家电维修员</label>
				</div>
				<div class="radio radio-inline">
					<input type="radio" name="type" id="type-3" value="pickup" <?php  if($deliveryer['type'] == 'pickup') { ?>checked<?php  } ?>>
					<label for="type-3">废品回收员</label>
				</div>
				<div class="radio radio-inline">
					<input type="radio" name="type" id="type-4" value="errand" <?php  if($deliveryer['type'] == 'errand') { ?>checked<?php  } ?>>
