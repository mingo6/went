				...
				<?php  if(is_array($lists)) { foreach($lists as $item) { ?>
					...
					<tr>
						...
						<td style="text-align:right; overflow: inherit">
							...
							<a href="<?php  echo iurl('store/shop/setting', array('_sid' => $item['id']))?>" target="_blank" class="btn btn-default btn-sm" style="color:#D9534F;"><i class="fa fa-cog fa-spin"> </i> 管理</a>
						</td>
					</tr>
				<?php  } } ?>
				</tbody>
