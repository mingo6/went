    ...
    $(function(){
        ...
        $("#alldel").on('click',function(){
            ...
            if(check.length < 1){
                ...
                $.ajax({
                    type:"post",
                    url:"<?php  echo $_W['siteroot'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=DelJfGoods&m=zh_cjdianc",
                    dataType:"text",
                    data:{id:id},
        ...
        $("#allsj").on('click',function(){
            ...
            if(check.length < 1){
                ...
                $.ajax({
                    type:"post",
                    url:"<?php  echo $_W['siteroot'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=JfGoodsSj&m=zh_cjdianc",
                    dataType:"text",
                    data:{id:id},
                    success:function(data){
                        console.log(data);      
        ...
        $("#allxj").on('click',function(){
            ...
            if(check.length < 1){
                ...
                $.ajax({
                    type:"post",
                    url:"<?php  echo $_W['siteroot'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=JfGoodsXj&m=zh_cjdianc",
                    dataType:"text",
                    data:{id:id},
                    success:function(data){
                        console.log(data);      
