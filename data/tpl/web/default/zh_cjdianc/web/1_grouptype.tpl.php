...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php  echo $this->createWebUrl('grouptype')?>">商品分类管理</a></li>

    <li><a href="<?php  echo $this->createWebUrl('addgrouptype')?>">添加商品分类</a></li>
                    ...
                    <table class="yg5_tabel col-md-12">
                        ...
                        <tr class="yg5_tr2">
                            ...
                            <td>
                                ...
                                <img class="store_list_img" src="<?php  echo $row['img'];?>" alt=""/>                                
                            ...
                            <td>
                                ...
                                <a href="<?php  echo $this->createWebUrl('addgrouptype', array('id' => $row['id']))?>" class="storespan btn btn-xs">
                                ...
                                <!-- <a class="btn btn-warning btn-xs" href="<?php  echo $this->createWebUrl('addgrouptype', array('id' => $row['id']))?>" title="编辑">改</a>&nbsp;&nbsp;
                      ...
                      <div class="modal-dialog" role="document">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            ...
                            <a href="<?php  echo $this->createWebUrl('grouptype', array('id' => $row['id']))?>" type="button" class="btn btn-info" >确定</a>
