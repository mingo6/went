...
<ul class="nav nav-tabs">
    ...
    <li <?php  if($type=='all') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('qgorderall',array('type'=>all));?>">全部订单</a></li>
    <li <?php  if($type=='now') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('qgorderall',array('type'=>now));?>">待核销</a></li>
    <li <?php  if($type=='ok') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('qgorderall',array('type'=>ok));?>">已核销</a></li>
</ul>
<div class="row ygrow">
    <div class="col-lg-11 nav_head">
        <form action="" method="get" style="padding: 0" class="col-md-4">
            ...
            <input type="hidden" name="do" value="qgorderall" />
            <div class="input-group" style="width: 300px;">
                <input type="text" name="keywords" value="<?php  echo $_GPC['keywords'];?>" class="form-control" placeholder="请输入姓名/订单编号/门店名称">
...
<!--<a href="<?php  echo $this->createWebUrl('qgorder',array('op'=>'dy','order_id'=>$item['id']));?>"><button class="btn btn-xs orderbtn">打印小票</button></a> -->
                        </div>
                        <div class="right">
                        <?php  if($item['state']==2) { ?>
                            <div class="left orderconfirm2">待核销</div>
                        <?php  } else if($item['state']==3) { ?>
                            <div class="left orderconfirm2">已核销</div> 
                        <?php  } ?>
                        </div>                        
                    </div>
                    <div class="col-md-12 orderback2">
                        <div class="ordername">
                            <div class="left ordername1"><?php  echo $item['user_name'];?>&nbsp;&nbsp;<span class="orfont4">#<?php  echo $item['md_name'];?></span></div>
                        </div>
                        <div class="">
                            <div class="right ordertelimg1">
                                <img src="../addons/zh_cjdianc/template/images/ordertel.png" class="ordertelimg">
                                <span><?php  echo $item['user_tel'];?> </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 orderback2">
                    ...
                    <div class="col-md-12 orderback2">
                        ...
                        <div class="orderdish">
                            <div class="left orderdish1"><?php  echo $item['good_name'];?></div>
                            <div class="left">¥<?php  echo $item['money'];?></div>
                    ...
                    <div class="col-md-12 orderback2">
                        ...
                        <div class="orderaccount">
                            ...
                            <div class="orderbox2 left"><?php  if($item['pay_type']==1) { ?>微信支付<?php  } else if($item['pay_type']==2) { ?>余额支付<?php  } ?></div>
                        </div>                      
                    </div>
                    <div class="col-md-12 orderback2">
                    ...
                    <div class="col-md-12 orderback3">
                        ...
                        <span class="ordertime">下单时间：<?php  echo $item['pay_time'];?></span>
