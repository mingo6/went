...
<style>
	...
	.yyhome{font-size: 15px;position: relative;}
	...
	.fa-pencil-square-o,.fa-comments,.fa-star-half-o,.fa-users,.fa-user,.fa-clipboard,.fa-money,.fa-life-ring,.fa-bars,.fa-recycle,.fa-cog,.fa-book,.fa-database,.fa-gift,.fa-user,.fa-newspaper-o,.fa-binoculars,.fa-trophy,.fa-key{margin-right: 15px;}
...
<?php  $res=pdo_get('cjdc_system',array('uniacid'=>$_W['uniacid']))?>
<div class="header">
	<div class="wheaderbox">
		<img class="header_logo" src="<?php  if($res['link_logo']) { ?><?php  echo tomedia($res['link_logo'])?><?php  } else { ?>../addons/zh_cjdianc/template/images/htlogo.png<?php  } ?>" alt=""/>
    ...
    <div class="header_left">        
        ...
        <a href="<?php  echo $this->createWebUrl('store')?>"><div class="header_btn">返回首页</div></a>
         <?php  } ?>  
    </div>
		...
		<div class="row">
			...
			<div class="row yg_top">
				...
				<div class="big-menu">									
					...
					<?php  if($cur_store) { ?>
					<div class="yg_login">
						<img src="<?php  echo $cur_store['logo'];?>">
