...
<style type="text/css">
	...
	.home .store-list .common-no-con{margin-top:-5rem;top:70%;position:absolute;}
...
<div class="page errander-index home" id="page-app-index">
	...
	<header class="bar bar-nav common-bar-nav">
		<a class="pull-right open-popup" href="<?php  echo imurl('errander/order/list');?>">订单</a>
		<h1 class="title">生活服务</h1>
		<?php  if($_W['is_agent']) { ?>
		<a class="pull-right" href="<?php  echo imurl('errander/agent/index');?>"><?php  echo $_W['agent']['area'];?><span class="icon icon-xiangxia2"></span></a>
		<?php  } ?>
	</header>
	<?php  get_mall_menu();?>
	<div class="content">
