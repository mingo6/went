...
<div class="page errander-index errander-submit">
    ...
    <nav class="bar bar-tab footer-bar border-1px-t nav-button">
        <div class="fee-block">
            <div>费用 <span class="tip hide"> + 小费</span><span class="color-danger">¥ <span id="final-fee">0</span></span></div>
        </div>
        ...
        <ul class="border-1px-tb">
            <li class="item-content item-link">
                ...
                <div class="item-inner open-popup" data-popup=".popup-select-end-address" id="end-address">
                    ...
                    <?php  } else { ?>
                    <div class="item-title color-gray">请输入上门地址(必填)</div>
                    <?php  } ?>
                </div>
            </li>
        </ul>
    ...
    <div class="content-block-title">寄件信息</div>
    <div class="list-block">
        <ul class="border-1px-tb" style="">
            <li class="item-content">
                <!--<div class="item-media"><i class="icon icon-buy-cart"></i></div>-->
                <div class="item-title label" style="width: 25%;">物品名称</div>
                <div class="item-inner border-1px-b">
                    <div class="item-input">
                        <input type="text" name="goods_name" value="" id="goods-title" placeholder="请输入物品名称">
                    </div>
                </div>
            </li>
            ...
            <li class="item-content border-1px-b">
                <div class="item-inner">
                    <div class="item-title label" style="width: 25%;">物品重量</div>
                    <div class="item-inner border-1px-b">
                        <div class="item-input">
                            <input type="text" name="goods_weight" <?php  if(!empty($errander_order['goods_weight'])) { ?>value="<?php  echo $errander_order['goods_weight'];?>"<?php  } else { ?>value="<?php  echo $category['weight_fee']['start_weight'];?>"<?php  } ?> placeholder="请输入物品重量（kg）">
                        </div>
                    </div>
                    <!--<div class="item-title label">重量</div>-->
                    <!--<div class="item-input weight">-->
                        <!--<input type="text" name="goods_weight" <?php  if(!empty($errander_order['goods_weight'])) { ?>value="<?php  echo $errander_order['goods_weight'];?>"<?php  } else { ?>value="<?php  echo $category['weight_fee']['start_weight'];?>"<?php  } ?> class="text-right" placeholder="请输入物品重量（kg）<?php  if(empty($category['weight_fee_status'])) { ?><?php  } ?>">-->
                        <!--<small>公斤</small>-->
                    <!--</div>-->
                </div>
            </li>
            ...
            <li class="item-content">
                <div class="item-title label" style="width: 25%;">收件人姓名</div>
                <div class="item-inner border-1px-b">
                    <div class="item-input">
                        <input type="text" name="buy_username" value="" id="buy_username" placeholder="请输入收件人姓名">
                    </div>
                </div>
            </li>

            <li class="item-content">
                <div class="item-title label" style="width: 25%;">收件人电话</div>
                <div class="item-inner border-1px-b">
                    <div class="item-input">
                        <input type="text" name="buy_mobile" value="" id="buy_mobile" placeholder="请输入收件人电话">
                    </div>
                </div>
            </li>
            ...
            <li class="item-content item-link border-1px-b">
                ...
                <div class="item-inner open-popup" data-popup=".popup-select-buy-address" id="start-address">
                    ...
                    <?php  } else { ?>
                    <div class="item-title color-gray">请输入收货人地址(选填)</div>
                    <?php  } ?>
                </div>
            </li>
    ...
    <textarea name="note" class="note border-1px-tb" value="" placeholder="输入详细要求,可选填" rows="3"><?php  echo $errander_order['note'];?></textarea>
        ...
        <ul>
            <li class="item-content item-link border-1px-tb delivery-time" id="delivery-time-1">
                <div class="item-inner">
                    ...
                    <div class="item-after"><span class="color-black delivery-time-show">立刻</span></div>
                </div>
            </li>
            <li class="item-content no-bottom">
                <div class="item-inner">
                    <div class="item-title delivery-fee-modal js-open-delivery-fee-modal" data-modal=".modal-delivery-fee">费用 <i class="icon icon-question-circle" style="display: none;"></i></div>
