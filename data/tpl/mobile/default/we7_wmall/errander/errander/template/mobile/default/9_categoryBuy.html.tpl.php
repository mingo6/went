...
<div class="page errander-index errander-submit">
	...
	<div class="content">
		<div class="com-title-list" style="<?php  if($original_type=='express') { ?>display:none<?php  } ?>">
			<?php  if(is_array($category_list)) { foreach($category_list as $index => $item) { ?>
				...
				<li class="item-content">
					...
					<div class="item-inner border-1px-b">
						<div class="item-input">
							<input type="text" name="goods_name" value="1" id="goods-title" placeholder="请输入需求">
						</div>
					</div>
				</li>
