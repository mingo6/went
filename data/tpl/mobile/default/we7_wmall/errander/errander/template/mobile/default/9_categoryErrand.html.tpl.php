...
<div class="page errander-index errander-submit">
    ...
    <div class="content">
        ...
        <div class="list-block">
            <ul class="border-1px-tb">
                <li class="item-content item-link border-1px-b" style="">
                    ...
                    <div class="item-inner open-popup" data-popup=".popup-select-buy-address" id="start-address">
                        ...
                        <?php  } else { ?>
                        <div class="item-title color-gray">请输入取货/购买地址(选填)</div>
                        <?php  } ?>
                    </div>
                </li>
        ...
        <div class="list-block">
            <ul>
                ...
                <li class="item-content no-bottom">
                    <div class="item-inner">
                        <div class="item-title delivery-fee-modal js-open-delivery-fee-modal" data-modal=".modal-delivery-fee">费用 <i class="icon icon-question-circle"></i></div>
