		...
		<div id="order-detail" class="tab active">
			...
			<div class="list-block other-info  border-1px-b" style="margin: 0">
				...
				<div class="table">
					...
					<a href="javascript:;" class="table-cell external border-1px-l js-location" data-lat="<?php  echo $store['location_x'];?>" data-lng="<?php  echo $store['location_y'];?>" data-name="<?php  echo $store['title'];?>" data-address="<?php  echo $store['address'];?>">导航</a>
				</div>
			</div>
			...
			<div class="list-block other-info border-1px-b" style="margin: 0">
				...
				<div class="table">
					...
					<a href="javascript:;" class="table-cell external border-1px-l js-location" data-lat="<?php  echo $order['location_x'];?>" data-lng="<?php  echo $order['location_y'];?>" data-name="<?php  echo $order['address'];?>" data-address="<?php  echo $order['address'];?>">导航</a>
				</div>
			</div>
