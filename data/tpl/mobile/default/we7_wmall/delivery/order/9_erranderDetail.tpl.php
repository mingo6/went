...
<div class="page order-info" id="page-delivery-order">
	...
	<?php  } else if($order['delivery_status'] == 3) { ?>
		<nav class="bar bar-tab footer-bar">
			...
			<?php  } ?>
			<a href="javascript:;" class="tab-item order-errander-success" data-id="<?php  echo $order['id'];?>" data-vcode="<?php  echo $order['verification_code'];?>"  data-type="<?php  echo $order['order_type'];?>">
