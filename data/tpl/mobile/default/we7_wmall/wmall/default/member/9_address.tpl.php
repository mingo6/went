...
<div class="page address-list">
	...
	<a href="<?php  echo imurl('wmall/member/address/post', $param);?>" class="bar bar-tab text-center logout"><i class="icon icon-plus"></i>新增地址</a>
	<div class="content">
							...
							<div class="item-inner border-1px-b">
								<div class="row no-gutter">
									...
									<div class="col-20 address-edit">
										<a class="external" href="<?php  echo imurl('wmall/member/address/post',$param);?>&id=<?php  echo $address['id'];?>"><img src="<?php echo WE7_WMALL_TPL_URL;?>static/img/address_edit.png" alt="" /></a>
									</div>
								</div>
							</div>
						</li>
