...
<style type="text/css">
.footmark .store-list .list-item .col-60{
	padding-top: 0.2rem;
}
.store-info.row.no-gutter{
	flex:1;
}
.footmark .store-list .list-item{
	padding: .5rem 0 0;
}
.footmark .sailed{
	position: relative;
...
.footmark .store-list .store-label{
	padding:2px;
	margin-right:10px;
}
</style>
										...
										<div class="store-info row no-gutter">
											...
											<div class="col-75">
												<div class="row no-gutter">
													<div class="col-60 text-ellipsis" style="display:flex;align-items: center;">
														...
														<?php  } ?>
														<?php  echo $stores[$mark['sid']]['title'];?>
													</div>
