	...
	<div class="content">
		...
		<div class="list-block">
			<ul class="border-1px-tb">
				...
				<?php  } } ?>
				<?php  if($store['delivery_free_price'] > 0 && $store['delivery_fee_mode'] < 3) { ?>
				<li>
					<div class="item-content">
		...
		<?php  if(!empty($store['qualification']) && !empty($store['qualification']['business']) || !empty($store['qualification']['service']) || !empty($store['qualification']['more1']) || !empty($store['qualification']['more2'])) { ?>
