...
/*@media (min-width: 1024px) {
	...
	.store .category-container .children-category .heading{
		line-height: 1.5rem;
		height: 1.5rem;
	}
	.store .category-container .children-category .heading span{
		border:none;
	}
	.store .parent-category ul li.active{
		border:none;
	}
	.store .parent-category ul li{
		background-color:#eee;
	}
	.store .parent-category{
		margin-top: 1px;
	}
	.store .category-container .children-category .children-category-wrapper:last-child{
		border:none;
	}
	.shopcategory .content{
		padding-bottom:2.5rem;
	}
	.operate-num .icon-plus{
		width:1rem;
		height: 1rem;
		line-height: 1rem;
		font-size:.65rem;
	...
	.store .category-container .children-category .item-media img{
		width:4rem;
		height:4rem;
	}
	.store .category-container .children-category .item-inner{margin-left: .5rem;}
	.store .category-container .children-category .price .fee{font-size: .7rem;}
	.goods-tips{bottom:.55rem;}
	.store .category-container .children-category .operate-goods{bottom:.5rem;}
	.store .category-container .children-category .item-title{font-size: .75rem;font-weight: bold;}
	.store .category-container .children-category .goods-info{
	    margin-top: .2rem;
	    max-height:.6rem;
	    line-height:.5rem;
	    -webkit-line-clamp:1;
	}
	.store .parent-category ul li a{
		font-size: .6rem;
	}
									...
									<li id="goods-<?php  echo $ds['id'];?>" <?php  if($_GPC['goods_id'] == $ds['id']) { ?>class="active"<?php  } ?>>
										<a class="item-content" href="javascript:;">
											<div class="item-media goods-popup"  data-id="<?php  echo $ds['id'];?>">
												<!-- class="lazyload" -->
												<img src="<?php  echo tomedia($ds['thumb']);?>"  alt=""/>
											</div>
