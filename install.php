	...
	if($ispost) {
		...
		if(empty($error)) {
			...
			if($_POST['type'] == 'remote') {
				...
				if($ins == 'error') {
					die('<script type="text/javascript">alert("版本错误，请确认是否为勤瀚堂最新版安装文件！");history.back();</script>');
				}
			...
			if(file_exists(IA_ROOT . '/index.php') && is_dir(IA_ROOT . '/web') && file_exists($verfile) && file_exists($dbfile)) {
				...
				die('<script type="text/javascript">alert("你正在使用本地安装, 但未下载完整安装包, 请从勤瀚堂官网下载完整安装包后重试.");history.back();</script>');
			}
...
<html lang="zh-cn">
	<head>
		...
		<title>安装系统 - 勤瀚堂 - 公众平台自助开源引擎</title>
		...
		<div class="container" style="width:1200px;">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					<li role="presentation" class="active"><a href="javascript:;">安装勤瀚堂系统</a></li>
					<li role="presentation"><a href="http://www.qinhantangtop.com">勤瀚堂官网</a></li>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a href="http://www.qinhantangtop.com">关于勤瀚堂</a> &nbsp; &nbsp; <a href="http://bbs.we7.cc">勤瀚堂帮助</a> &nbsp; &nbsp; <a href="http://www.qinhantangtop.com">购买授权</a>
				</div>
				<div class="text-center">
					Powered by <a href="http://www.qinhantangtop.com"><b>勤瀚堂</b></a> v0.8 &copy; 2014 <a href="http://www.qinhantangtop.com">www.qinhantangtop.com</a>
				</div>
			</div>
		</div>
	...
	echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				<h3>版权所有 (c)2014，勤瀚堂团队保留所有权利。 </h3>
				<p>
					感谢您选择勤瀚堂 - 微信公众平台自助开源引擎（以下简称WE7，WE7基于 PHP + MySQL的技术开发，全部源码开放。 <br />
					为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
				</p>
				<p>
					<strong>一、本授权协议适用且仅适用于勤瀚堂系统(We7, MicroEngine. 以下简称勤瀚堂)任何版本，勤瀚堂官方对本授权协议的最终解释权。</strong>
				</p>
				<p>
					<strong>二、协议许可的权利 </strong>
					<ol>
						<li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。</li>
						<li>您可以在协议规定的约束和限制范围内修改勤瀚堂源代码或界面风格以适应您的网站要求。</li>
				...
				<p>
					...
					<ol>
						...
						<li>未经官方许可，禁止在勤瀚堂的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
...
function tpl_install_env($ret = array()) {
	...
	echo <<<EOF
		...
		<div class="alert alert-info">系统要求勤瀚堂整个安装目录必须可写, 才能使用勤瀚堂所有功能。</div>
		<div class="panel panel-default">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<div class="help-block">
							...
							在线安装能够直接安装最新版本勤瀚堂系统, 如果在线安装困难, 请下载离线安装包后使用本地安装. <br/>
...
function tpl_install_finish() {
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“勤瀚堂 - 公众平台自助开源引擎”系统，您现在可以: <a target="_blank" class="btn btn-success" href="./web/index.php">访问网站首页</a>
	</div>
	<div class="form-group">
		<h5><strong>勤瀚堂应用商城</strong></h5>
